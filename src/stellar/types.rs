...
//!
// This code has been automatically generated on 2021-07-08
...
impl XdrCodec for Asset {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match AssetType::from_xdr_buffered(read_stream)? {
            ...
            AssetType::AssetTypeCreditAlphanum4 => Ok(Asset::AssetTypeCreditAlphanum4(AssetAlphaNum4::from_xdr_buffered(read_stream)?)),
            AssetType::AssetTypeCreditAlphanum12 => Ok(Asset::AssetTypeCreditAlphanum12(AssetAlphaNum12::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for OperationId {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            OperationId::EnvelopeTypeOpId(value) => {EnvelopeType::EnvelopeTypeOpId.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match EnvelopeType::from_xdr_buffered(read_stream)? {
            EnvelopeType::EnvelopeTypeOpId => Ok(OperationId::EnvelopeTypeOpId(OperationIdId::from_xdr_buffered(read_stream)?)),
...
impl XdrCodec for BeginSponsoringFutureReservesResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ...
            BeginSponsoringFutureReservesResult::Default(code) => code.to_xdr_buffered(write_stream),
        }
    }
