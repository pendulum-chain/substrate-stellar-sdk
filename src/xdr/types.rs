...
//!
// This code has been automatically generated on 2023-10-02
...
impl XdrCodec for ConfigSettingContractExecutionLanesV0 {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        Ok(ConfigSettingContractExecutionLanesV0 {
            ledger_max_tx_count: Uint32::from_xdr_buffered(read_stream)?,
        })
    }
}
...
impl XdrCodec for ConfigSettingContractHistoricalDataV0 {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        Ok(ConfigSettingContractHistoricalDataV0 {
            fee_historical1_kb: Int64::from_xdr_buffered(read_stream)?,
        })
    }
}
...
/// Autogenerated definition for type StateExpirationSettings
#[allow(dead_code)]
#[derive(Debug, Clone, Eq, PartialEq)]
pub struct StateExpirationSettings {
    pub max_entry_expiration: Uint32,
    pub min_temp_entry_expiration: Uint32,
    pub min_persistent_entry_expiration: Uint32,
    pub persistent_rent_rate_denominator: Int64,
    pub temp_rent_rate_denominator: Int64,
    pub max_entries_to_expire: Uint32,
    pub bucket_list_size_window_sample_size: Uint32,
    pub eviction_scan_size: Uint64,
    pub starting_eviction_scan_level: Uint32
}

impl XdrCodec for StateExpirationSettings {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        self.max_entry_expiration.to_xdr_buffered(write_stream);
        self.min_temp_entry_expiration.to_xdr_buffered(write_stream);
        self.min_persistent_entry_expiration.to_xdr_buffered(write_stream);
        ...
        self.max_entries_to_expire.to_xdr_buffered(write_stream);
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        Ok(StateExpirationSettings {
            max_entry_expiration: Uint32::from_xdr_buffered(read_stream)?,
            min_temp_entry_expiration: Uint32::from_xdr_buffered(read_stream)?,
            min_persistent_entry_expiration: Uint32::from_xdr_buffered(read_stream)?,
...
impl XdrCodec for ConfigSettingId {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match enum_value {
            ...
            10 => Ok(ConfigSettingId::ConfigSettingStateExpiration),
...
impl XdrCodec for ScSpecTypeOption {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        Ok(ScSpecTypeOption {
            value_type: Box::new(ScSpecTypeDef::from_xdr_buffered(read_stream)?),
        })
    }
}
...
impl XdrCodec for ScSpecTypeVec {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        Ok(ScSpecTypeVec {
            element_type: Box::new(ScSpecTypeDef::from_xdr_buffered(read_stream)?),
        })
    }
}
...
impl XdrCodec for ScSpecTypeBytesN {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        Ok(ScSpecTypeBytesN {
            n: Box::new(Uint32::from_xdr_buffered(read_stream)?),
        })
    }
}
...
impl XdrCodec for ScSpecTypeUdt {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        Ok(ScSpecTypeUdt {
            name: Box::new(LimitedString::<60>::from_xdr_buffered(read_stream)?),
        })
    }
}
...
impl XdrCodec for UInt128Parts {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        Ok(UInt128Parts {
            hi: Uint64::from_xdr_buffered(read_stream)?,
            lo: Uint64::from_xdr_buffered(read_stream)?,
        })
    }
}
...
impl XdrCodec for Int128Parts {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        Ok(Int128Parts {
            hi: Int64::from_xdr_buffered(read_stream)?,
            lo: Uint64::from_xdr_buffered(read_stream)?,
        })
    }
}
...
impl XdrCodec for ContractExecutableType {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match enum_value {
            ...
            1 => Ok(ContractExecutableType::ContractExecutableToken),
            _ => Err(DecodeError::InvalidEnumDiscriminator {at_position: read_stream.get_position()})
        }
    }
}
...
impl XdrCodec for LedgerEntryType {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match enum_value {
            ...
            9 => Ok(LedgerEntryType::Expiration),
            _ => Err(DecodeError::InvalidEnumDiscriminator {at_position: read_stream.get_position()})
        }
    }
}
...
impl XdrCodec for AccountEntryExtensionV2 {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        Ok(AccountEntryExtensionV2 {
            ...
            signer_sponsoring_i_ds: LimitedVarArray::<SponsorshipDescriptor, MAX_SIGNERS>::from_xdr_buffered(read_stream)?,
...
/// Autogenerated definition for type ExpirationEntry
#[allow(dead_code)]
#[derive(Debug, Clone, Eq, PartialEq)]
pub struct ExpirationEntry {
    pub key_hash: Hash,
    pub expiration_ledger_seq: Uint32
}

impl XdrCodec for ExpirationEntry {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        self.key_hash.to_xdr_buffered(write_stream);
        self.expiration_ledger_seq.to_xdr_buffered(write_stream);
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        Ok(ExpirationEntry {
            ...
            expiration_ledger_seq: Uint32::from_xdr_buffered(read_stream)?,
        })
    }
}
...
impl XdrCodec for LedgerKeyConfigSetting {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        Ok(LedgerKeyConfigSetting {
            config_setting_id: ConfigSettingId::from_xdr_buffered(read_stream)?,
        })
    }
}
...
impl XdrCodec for LedgerKeyExpiration {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        self.key_hash.to_xdr_buffered(write_stream);
    }
...
impl XdrCodec for ConfigUpgradeSet {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        Ok(ConfigUpgradeSet {
            updated_entry: UnlimitedVarArray::<ConfigSettingEntry>::from_xdr_buffered(read_stream)?,
        })
    }
}
...
/// Autogenerated definition for type LedgerCloseMetaV2
#[allow(dead_code)]
#[cfg(feature = "all-types")]
#[derive(Debug, Clone, Eq, PartialEq)]
...
#[cfg(feature = "all-types")]
impl XdrCodec for LedgerCloseMetaV2 {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        self.ext.to_xdr_buffered(write_stream);
        self.ledger_header.to_xdr_buffered(write_stream);
        self.tx_set.to_xdr_buffered(write_stream);
...
impl XdrCodec for Auth {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        Ok(Auth {
            flags: i32::from_xdr_buffered(read_stream)?,
        })
    }
}
...
impl XdrCodec for FloodAdvert {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        Ok(FloodAdvert {
            tx_hashes: TxAdvertVector::from_xdr_buffered(read_stream)?,
        })
    }
}
...
impl XdrCodec for FloodDemand {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        Ok(FloodDemand {
            tx_hashes: TxDemandVector::from_xdr_buffered(read_stream)?,
        })
    }
}
...
impl XdrCodec for OperationType {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match enum_value {
            ...
            25 => Ok(OperationType::BumpFootprintExpiration),
...
/// Autogenerated definition for type BumpFootprintExpirationOp
#[allow(dead_code)]
#[derive(Debug, Clone, Eq, PartialEq)]
pub struct BumpFootprintExpirationOp {
    pub ext: ExtensionPoint,
    pub ledgers_to_expire: Uint32
}

impl XdrCodec for BumpFootprintExpirationOp {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        self.ext.to_xdr_buffered(write_stream);
        self.ledgers_to_expire.to_xdr_buffered(write_stream);
    }

    fn from_xdr_buffered<T: AsRef<[u8]>>(
        read_stream: &mut ReadStream<T>,
    ) -> Result<Self, DecodeError> {
        Ok(BumpFootprintExpirationOp {
            ext: ExtensionPoint::from_xdr_buffered(read_stream)?,
...
impl XdrCodec for SorobanTransactionData {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        ...
        self.refundable_fee.to_xdr_buffered(write_stream);
    }
...
impl XdrCodec for InvokeHostFunctionResultCode {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match enum_value {
            ...
            -4 => Ok(InvokeHostFunctionResultCode::InvokeHostFunctionEntryExpired),
...
/// Autogenerated definition for type BumpFootprintExpirationResultCode
#[allow(dead_code)]
#[derive(Debug, Copy, Clone, Eq, PartialEq)]
...
impl XdrCodec for BumpFootprintExpirationResultCode {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        let value = *self as i32;
        value.to_xdr_buffered(write_stream);
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        let enum_value = i32::from_xdr_buffered(read_stream)?;
        match enum_value {
            0 => Ok(BumpFootprintExpirationResultCode::BumpFootprintExpirationSuccess),
            -1 => Ok(BumpFootprintExpirationResultCode::BumpFootprintExpirationMalformed),
            -2 => Ok(BumpFootprintExpirationResultCode::BumpFootprintExpirationResourceLimitExceeded),
            -3 => Ok(BumpFootprintExpirationResultCode::BumpFootprintExpirationInsufficientRefundableFee),
            _ => Err(DecodeError::InvalidEnumDiscriminator {at_position: read_stream.get_position()})
        }
    }
}
...
impl XdrCodec for ScpStatementPledges {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ScpStatementPledges::ScpStPrepare(value) => {ScpStatementType::ScpStPrepare.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScpStatementPledges::ScpStConfirm(value) => {ScpStatementType::ScpStConfirm.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScpStatementPledges::ScpStExternalize(value) => {ScpStatementType::ScpStExternalize.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScpStatementPledges::ScpStNominate(value) => {ScpStatementType::ScpStNominate.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match ScpStatementType::from_xdr_buffered(read_stream)? {
            ScpStatementType::ScpStPrepare => Ok(ScpStatementPledges::ScpStPrepare(ScpStatementPrepare::from_xdr_buffered(read_stream)?)),
            ScpStatementType::ScpStConfirm => Ok(ScpStatementPledges::ScpStConfirm(ScpStatementConfirm::from_xdr_buffered(read_stream)?)),
            ScpStatementType::ScpStExternalize => Ok(ScpStatementPledges::ScpStExternalize(ScpStatementExternalize::from_xdr_buffered(read_stream)?)),
            ScpStatementType::ScpStNominate => Ok(ScpStatementPledges::ScpStNominate(ScpNomination::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for ConfigSettingEntry {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ConfigSettingEntry::ConfigSettingContractMaxSizeBytes(value) => {ConfigSettingId::ConfigSettingContractMaxSizeBytes.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ConfigSettingEntry::ConfigSettingContractComputeV0(value) => {ConfigSettingId::ConfigSettingContractComputeV0.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ConfigSettingEntry::ConfigSettingContractLedgerCostV0(value) => {ConfigSettingId::ConfigSettingContractLedgerCostV0.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ConfigSettingEntry::ConfigSettingContractHistoricalDataV0(value) => {ConfigSettingId::ConfigSettingContractHistoricalDataV0.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ConfigSettingEntry::ConfigSettingContractEventsV0(value) => {ConfigSettingId::ConfigSettingContractEventsV0.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ConfigSettingEntry::ConfigSettingContractBandwidthV0(value) => {ConfigSettingId::ConfigSettingContractBandwidthV0.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ConfigSettingEntry::ConfigSettingContractCostParamsCpuInstructions(value) => {ConfigSettingId::ConfigSettingContractCostParamsCpuInstructions.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ConfigSettingEntry::ConfigSettingContractCostParamsMemoryBytes(value) => {ConfigSettingId::ConfigSettingContractCostParamsMemoryBytes.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ConfigSettingEntry::ConfigSettingContractDataKeySizeBytes(value) => {ConfigSettingId::ConfigSettingContractDataKeySizeBytes.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ConfigSettingEntry::ConfigSettingContractDataEntrySizeBytes(value) => {ConfigSettingId::ConfigSettingContractDataEntrySizeBytes.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ConfigSettingEntry::ConfigSettingStateExpiration(value) => {ConfigSettingId::ConfigSettingStateExpiration.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ConfigSettingEntry::ConfigSettingContractExecutionLanes(value) => {ConfigSettingId::ConfigSettingContractExecutionLanes.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ConfigSettingEntry::ConfigSettingBucketlistSizeWindow(value) => {ConfigSettingId::ConfigSettingBucketlistSizeWindow.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ConfigSettingEntry::ConfigSettingEvictionIterator(value) => {ConfigSettingId::ConfigSettingEvictionIterator.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match ConfigSettingId::from_xdr_buffered(read_stream)? {
            ConfigSettingId::ConfigSettingContractMaxSizeBytes => Ok(ConfigSettingEntry::ConfigSettingContractMaxSizeBytes(Uint32::from_xdr_buffered(read_stream)?)),
            ConfigSettingId::ConfigSettingContractComputeV0 => Ok(ConfigSettingEntry::ConfigSettingContractComputeV0(ConfigSettingContractComputeV0::from_xdr_buffered(read_stream)?)),
            ConfigSettingId::ConfigSettingContractLedgerCostV0 => Ok(ConfigSettingEntry::ConfigSettingContractLedgerCostV0(ConfigSettingContractLedgerCostV0::from_xdr_buffered(read_stream)?)),
            ConfigSettingId::ConfigSettingContractHistoricalDataV0 => Ok(ConfigSettingEntry::ConfigSettingContractHistoricalDataV0(ConfigSettingContractHistoricalDataV0::from_xdr_buffered(read_stream)?)),
            ConfigSettingId::ConfigSettingContractEventsV0 => Ok(ConfigSettingEntry::ConfigSettingContractEventsV0(ConfigSettingContractEventsV0::from_xdr_buffered(read_stream)?)),
            ConfigSettingId::ConfigSettingContractBandwidthV0 => Ok(ConfigSettingEntry::ConfigSettingContractBandwidthV0(ConfigSettingContractBandwidthV0::from_xdr_buffered(read_stream)?)),
            ConfigSettingId::ConfigSettingContractCostParamsCpuInstructions => Ok(ConfigSettingEntry::ConfigSettingContractCostParamsCpuInstructions(ContractCostParams::from_xdr_buffered(read_stream)?)),
            ConfigSettingId::ConfigSettingContractCostParamsMemoryBytes => Ok(ConfigSettingEntry::ConfigSettingContractCostParamsMemoryBytes(ContractCostParams::from_xdr_buffered(read_stream)?)),
            ConfigSettingId::ConfigSettingContractDataKeySizeBytes => Ok(ConfigSettingEntry::ConfigSettingContractDataKeySizeBytes(Uint32::from_xdr_buffered(read_stream)?)),
            ConfigSettingId::ConfigSettingContractDataEntrySizeBytes => Ok(ConfigSettingEntry::ConfigSettingContractDataEntrySizeBytes(Uint32::from_xdr_buffered(read_stream)?)),
            ConfigSettingId::ConfigSettingStateExpiration => Ok(ConfigSettingEntry::ConfigSettingStateExpiration(StateExpirationSettings::from_xdr_buffered(read_stream)?)),
            ConfigSettingId::ConfigSettingContractExecutionLanes => Ok(ConfigSettingEntry::ConfigSettingContractExecutionLanes(ConfigSettingContractExecutionLanesV0::from_xdr_buffered(read_stream)?)),
            ConfigSettingId::ConfigSettingBucketlistSizeWindow => Ok(ConfigSettingEntry::ConfigSettingBucketlistSizeWindow(UnlimitedVarArray::<Uint64>::from_xdr_buffered(read_stream)?)),
            ConfigSettingId::ConfigSettingEvictionIterator => Ok(ConfigSettingEntry::ConfigSettingEvictionIterator(EvictionIterator::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for ScEnvMetaEntry {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ScEnvMetaEntry::ScEnvMetaKindInterfaceVersion(value) => {ScEnvMetaKind::ScEnvMetaKindInterfaceVersion.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match ScEnvMetaKind::from_xdr_buffered(read_stream)? {
            ScEnvMetaKind::ScEnvMetaKindInterfaceVersion => Ok(ScEnvMetaEntry::ScEnvMetaKindInterfaceVersion(Uint64::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for ScMetaEntry {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ScMetaEntry::ScMetaV0(value) => {ScMetaKind::ScMetaV0.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
...
impl XdrCodec for ScSpecTypeDef {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ...
            ScSpecTypeDef::ScSpecTypeOption(value) => {ScSpecType::ScSpecTypeOption.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScSpecTypeDef::ScSpecTypeResult(value) => {ScSpecType::ScSpecTypeResult.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScSpecTypeDef::ScSpecTypeVec(value) => {ScSpecType::ScSpecTypeVec.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScSpecTypeDef::ScSpecTypeMap(value) => {ScSpecType::ScSpecTypeMap.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScSpecTypeDef::ScSpecTypeTuple(value) => {ScSpecType::ScSpecTypeTuple.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScSpecTypeDef::ScSpecTypeBytesN(value) => {ScSpecType::ScSpecTypeBytesN.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScSpecTypeDef::ScSpecTypeUdt(value) => {ScSpecType::ScSpecTypeUdt.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match ScSpecType::from_xdr_buffered(read_stream)? {
            ...
            ScSpecType::ScSpecTypeOption => Ok(ScSpecTypeDef::ScSpecTypeOption(Box::new(ScSpecTypeOption::from_xdr_buffered(read_stream)?))),
            ScSpecType::ScSpecTypeResult => Ok(ScSpecTypeDef::ScSpecTypeResult(Box::new(ScSpecTypeResult::from_xdr_buffered(read_stream)?))),
            ScSpecType::ScSpecTypeVec => Ok(ScSpecTypeDef::ScSpecTypeVec(Box::new(ScSpecTypeVec::from_xdr_buffered(read_stream)?))),
            ScSpecType::ScSpecTypeMap => Ok(ScSpecTypeDef::ScSpecTypeMap(Box::new(ScSpecTypeMap::from_xdr_buffered(read_stream)?))),
            ScSpecType::ScSpecTypeTuple => Ok(ScSpecTypeDef::ScSpecTypeTuple(Box::new(ScSpecTypeTuple::from_xdr_buffered(read_stream)?))),
            ScSpecType::ScSpecTypeBytesN => Ok(ScSpecTypeDef::ScSpecTypeBytesN(Box::new(ScSpecTypeBytesN::from_xdr_buffered(read_stream)?))),
            ScSpecType::ScSpecTypeUdt => Ok(ScSpecTypeDef::ScSpecTypeUdt(Box::new(ScSpecTypeUdt::from_xdr_buffered(read_stream)?))),
        }
    }
}
...
impl XdrCodec for ScSpecUdtUnionCaseV0 {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ScSpecUdtUnionCaseV0::ScSpecUdtUnionCaseVoidV0(value) => {ScSpecUdtUnionCaseV0Kind::ScSpecUdtUnionCaseVoidV0.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScSpecUdtUnionCaseV0::ScSpecUdtUnionCaseTupleV0(value) => {ScSpecUdtUnionCaseV0Kind::ScSpecUdtUnionCaseTupleV0.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match ScSpecUdtUnionCaseV0Kind::from_xdr_buffered(read_stream)? {
            ScSpecUdtUnionCaseV0Kind::ScSpecUdtUnionCaseVoidV0 => Ok(ScSpecUdtUnionCaseV0::ScSpecUdtUnionCaseVoidV0(ScSpecUdtUnionCaseVoidV0::from_xdr_buffered(read_stream)?)),
            ScSpecUdtUnionCaseV0Kind::ScSpecUdtUnionCaseTupleV0 => Ok(ScSpecUdtUnionCaseV0::ScSpecUdtUnionCaseTupleV0(ScSpecUdtUnionCaseTupleV0::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for ScSpecEntry {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ScSpecEntry::ScSpecEntryFunctionV0(value) => {ScSpecEntryKind::ScSpecEntryFunctionV0.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScSpecEntry::ScSpecEntryUdtStructV0(value) => {ScSpecEntryKind::ScSpecEntryUdtStructV0.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScSpecEntry::ScSpecEntryUdtUnionV0(value) => {ScSpecEntryKind::ScSpecEntryUdtUnionV0.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScSpecEntry::ScSpecEntryUdtEnumV0(value) => {ScSpecEntryKind::ScSpecEntryUdtEnumV0.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScSpecEntry::ScSpecEntryUdtErrorEnumV0(value) => {ScSpecEntryKind::ScSpecEntryUdtErrorEnumV0.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match ScSpecEntryKind::from_xdr_buffered(read_stream)? {
            ScSpecEntryKind::ScSpecEntryFunctionV0 => Ok(ScSpecEntry::ScSpecEntryFunctionV0(ScSpecFunctionV0::from_xdr_buffered(read_stream)?)),
            ScSpecEntryKind::ScSpecEntryUdtStructV0 => Ok(ScSpecEntry::ScSpecEntryUdtStructV0(ScSpecUdtStructV0::from_xdr_buffered(read_stream)?)),
            ScSpecEntryKind::ScSpecEntryUdtUnionV0 => Ok(ScSpecEntry::ScSpecEntryUdtUnionV0(ScSpecUdtUnionV0::from_xdr_buffered(read_stream)?)),
            ScSpecEntryKind::ScSpecEntryUdtEnumV0 => Ok(ScSpecEntry::ScSpecEntryUdtEnumV0(ScSpecUdtEnumV0::from_xdr_buffered(read_stream)?)),
            ScSpecEntryKind::ScSpecEntryUdtErrorEnumV0 => Ok(ScSpecEntry::ScSpecEntryUdtErrorEnumV0(ScSpecUdtErrorEnumV0::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for ScError {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ScError::SceContract(value) => {ScErrorType::SceContract.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScError::SceWasmVm(value) => {ScErrorType::SceWasmVm.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScError::SceContext(value) => {ScErrorType::SceContext.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScError::SceStorage(value) => {ScErrorType::SceStorage.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScError::SceObject(value) => {ScErrorType::SceObject.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScError::SceCrypto(value) => {ScErrorType::SceCrypto.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScError::SceEvents(value) => {ScErrorType::SceEvents.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScError::SceBudget(value) => {ScErrorType::SceBudget.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScError::SceValue(value) => {ScErrorType::SceValue.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScError::SceAuth(value) => {ScErrorType::SceAuth.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
...
impl XdrCodec for ContractExecutable {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ContractExecutable::ContractExecutableWasm(value) => {ContractExecutableType::ContractExecutableWasm.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ContractExecutable::ContractExecutableToken => ContractExecutableType::ContractExecutableToken.to_xdr_buffered(write_stream),
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match ContractExecutableType::from_xdr_buffered(read_stream)? {
            ContractExecutableType::ContractExecutableWasm => Ok(ContractExecutable::ContractExecutableWasm(Hash::from_xdr_buffered(read_stream)?)),
            ContractExecutableType::ContractExecutableToken => Ok(ContractExecutable::ContractExecutableToken),
        }
    }
}
...
impl XdrCodec for ScAddress {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ScAddress::ScAddressTypeAccount(value) => {ScAddressType::ScAddressTypeAccount.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScAddress::ScAddressTypeContract(value) => {ScAddressType::ScAddressTypeContract.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match ScAddressType::from_xdr_buffered(read_stream)? {
            ScAddressType::ScAddressTypeAccount => Ok(ScAddress::ScAddressTypeAccount(AccountId::from_xdr_buffered(read_stream)?)),
            ScAddressType::ScAddressTypeContract => Ok(ScAddress::ScAddressTypeContract(Hash::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for ScVal {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ScVal::ScvBool(value) => {ScValType::ScvBool.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScVal::ScvVoid => ScValType::ScvVoid.to_xdr_buffered(write_stream),
            ScVal::ScvError(value) => {ScValType::ScvError.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScVal::ScvU32(value) => {ScValType::ScvU32.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScVal::ScvI32(value) => {ScValType::ScvI32.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScVal::ScvU64(value) => {ScValType::ScvU64.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScVal::ScvI64(value) => {ScValType::ScvI64.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScVal::ScvTimepoint(value) => {ScValType::ScvTimepoint.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScVal::ScvDuration(value) => {ScValType::ScvDuration.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScVal::ScvU128(value) => {ScValType::ScvU128.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScVal::ScvI128(value) => {ScValType::ScvI128.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScVal::ScvU256(value) => {ScValType::ScvU256.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScVal::ScvI256(value) => {ScValType::ScvI256.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScVal::ScvBytes(value) => {ScValType::ScvBytes.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScVal::ScvString(value) => {ScValType::ScvString.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScVal::ScvSymbol(value) => {ScValType::ScvSymbol.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScVal::ScvVec(value) => {ScValType::ScvVec.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScVal::ScvMap(value) => {ScValType::ScvMap.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScVal::ScvAddress(value) => {ScValType::ScvAddress.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScVal::ScvLedgerKeyContractInstance => ScValType::ScvLedgerKeyContractInstance.to_xdr_buffered(write_stream),
            ScVal::ScvLedgerKeyNonce(value) => {ScValType::ScvLedgerKeyNonce.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ScVal::ScvContractInstance(value) => {ScValType::ScvContractInstance.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match ScValType::from_xdr_buffered(read_stream)? {
            ...
            ScValType::ScvContractInstance => Ok(ScVal::ScvContractInstance(ScContractInstance::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for StoredTransactionSet {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            StoredTransactionSet::V0(value) => {(0 as i32).to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            StoredTransactionSet::V1(value) => {(1 as i32).to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
...
impl XdrCodec for PersistedScpState {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            PersistedScpState::V0(value) => {(0 as i32).to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            PersistedScpState::V1(value) => {(1 as i32).to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
...
impl XdrCodec for AssetCode {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            AssetCode::AssetTypeCreditAlphanum4(value) => {AssetType::AssetTypeCreditAlphanum4.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            AssetCode::AssetTypeCreditAlphanum12(value) => {AssetType::AssetTypeCreditAlphanum12.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match AssetType::from_xdr_buffered(read_stream)? {
            AssetType::AssetTypeCreditAlphanum4 => Ok(AssetCode::AssetTypeCreditAlphanum4(AssetCode4::from_xdr_buffered(read_stream)?)),
            AssetType::AssetTypeCreditAlphanum12 => Ok(AssetCode::AssetTypeCreditAlphanum12(AssetCode12::from_xdr_buffered(read_stream)?)),
...
impl XdrCodec for Asset {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ...
            Asset::AssetTypeCreditAlphanum4(value) => {AssetType::AssetTypeCreditAlphanum4.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            Asset::AssetTypeCreditAlphanum12(value) => {AssetType::AssetTypeCreditAlphanum12.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match AssetType::from_xdr_buffered(read_stream)? {
            ...
            AssetType::AssetTypeCreditAlphanum4 => Ok(Asset::AssetTypeCreditAlphanum4(AlphaNum4::from_xdr_buffered(read_stream)?)),
            AssetType::AssetTypeCreditAlphanum12 => Ok(Asset::AssetTypeCreditAlphanum12(AlphaNum12::from_xdr_buffered(read_stream)?)),
...
impl XdrCodec for AccountEntryExtensionV2Ext {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ...
            AccountEntryExtensionV2Ext::V3(value) => {(3 as i32).to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
...
impl XdrCodec for AccountEntryExtensionV1Ext {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ...
            AccountEntryExtensionV1Ext::V2(value) => {(2 as i32).to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
...
impl XdrCodec for AccountEntryExt {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ...
            AccountEntryExt::V1(value) => {(1 as i32).to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
...
impl XdrCodec for TrustLineAsset {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ...
            TrustLineAsset::AssetTypeCreditAlphanum4(value) => {AssetType::AssetTypeCreditAlphanum4.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            TrustLineAsset::AssetTypeCreditAlphanum12(value) => {AssetType::AssetTypeCreditAlphanum12.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            TrustLineAsset::AssetTypePoolShare(value) => {AssetType::AssetTypePoolShare.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match AssetType::from_xdr_buffered(read_stream)? {
            ...
            AssetType::AssetTypeCreditAlphanum4 => Ok(TrustLineAsset::AssetTypeCreditAlphanum4(AlphaNum4::from_xdr_buffered(read_stream)?)),
            AssetType::AssetTypeCreditAlphanum12 => Ok(TrustLineAsset::AssetTypeCreditAlphanum12(AlphaNum12::from_xdr_buffered(read_stream)?)),
            AssetType::AssetTypePoolShare => Ok(TrustLineAsset::AssetTypePoolShare(PoolId::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for TrustLineEntryV1Ext {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ...
            TrustLineEntryV1Ext::V2(value) => {(2 as i32).to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
...
impl XdrCodec for TrustLineEntryExt {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ...
            TrustLineEntryExt::V1(value) => {(1 as i32).to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
...
impl XdrCodec for ClaimPredicate {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ClaimPredicate::ClaimPredicateUnconditional => ClaimPredicateType::ClaimPredicateUnconditional.to_xdr_buffered(write_stream),
            ClaimPredicate::ClaimPredicateAnd(value) => {ClaimPredicateType::ClaimPredicateAnd.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ClaimPredicate::ClaimPredicateOr(value) => {ClaimPredicateType::ClaimPredicateOr.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ClaimPredicate::ClaimPredicateNot(value) => {ClaimPredicateType::ClaimPredicateNot.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ClaimPredicate::ClaimPredicateBeforeAbsoluteTime(value) => {ClaimPredicateType::ClaimPredicateBeforeAbsoluteTime.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ClaimPredicate::ClaimPredicateBeforeRelativeTime(value) => {ClaimPredicateType::ClaimPredicateBeforeRelativeTime.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match ClaimPredicateType::from_xdr_buffered(read_stream)? {
            ...
            ClaimPredicateType::ClaimPredicateAnd => Ok(ClaimPredicate::ClaimPredicateAnd(LimitedVarArray::<ClaimPredicate, 2>::from_xdr_buffered(read_stream)?)),
            ClaimPredicateType::ClaimPredicateOr => Ok(ClaimPredicate::ClaimPredicateOr(LimitedVarArray::<ClaimPredicate, 2>::from_xdr_buffered(read_stream)?)),
            ClaimPredicateType::ClaimPredicateNot => Ok(ClaimPredicate::ClaimPredicateNot(Option::<Box<ClaimPredicate>>::from_xdr_buffered(read_stream)?)),
            ClaimPredicateType::ClaimPredicateBeforeAbsoluteTime => Ok(ClaimPredicate::ClaimPredicateBeforeAbsoluteTime(Int64::from_xdr_buffered(read_stream)?)),
            ClaimPredicateType::ClaimPredicateBeforeRelativeTime => Ok(ClaimPredicate::ClaimPredicateBeforeRelativeTime(Int64::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for Claimant {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            Claimant::ClaimantTypeV0(value) => {ClaimantType::ClaimantTypeV0.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
...
impl XdrCodec for ClaimableBalanceId {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ClaimableBalanceId::ClaimableBalanceIdTypeV0(value) => {ClaimableBalanceIdType::ClaimableBalanceIdTypeV0.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match ClaimableBalanceIdType::from_xdr_buffered(read_stream)? {
            ClaimableBalanceIdType::ClaimableBalanceIdTypeV0 => Ok(ClaimableBalanceId::ClaimableBalanceIdTypeV0(Hash::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for ClaimableBalanceEntryExt {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ...
            ClaimableBalanceEntryExt::V1(value) => {(1 as i32).to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
...
impl XdrCodec for LiquidityPoolEntryBody {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            LiquidityPoolEntryBody::LiquidityPoolConstantProduct(value) => {LiquidityPoolType::LiquidityPoolConstantProduct.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match LiquidityPoolType::from_xdr_buffered(read_stream)? {
            LiquidityPoolType::LiquidityPoolConstantProduct => Ok(LiquidityPoolEntryBody::LiquidityPoolConstantProduct(LiquidityPoolEntryConstantProduct::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for LedgerEntryData {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            LedgerEntryData::Account(value) => {LedgerEntryType::Account.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            LedgerEntryData::Trustline(value) => {LedgerEntryType::Trustline.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            LedgerEntryData::Offer(value) => {LedgerEntryType::Offer.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            LedgerEntryData::Data(value) => {LedgerEntryType::Data.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            LedgerEntryData::ClaimableBalance(value) => {LedgerEntryType::ClaimableBalance.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            LedgerEntryData::LiquidityPool(value) => {LedgerEntryType::LiquidityPool.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            LedgerEntryData::ContractData(value) => {LedgerEntryType::ContractData.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            LedgerEntryData::ContractCode(value) => {LedgerEntryType::ContractCode.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            LedgerEntryData::ConfigSetting(value) => {LedgerEntryType::ConfigSetting.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            LedgerEntryData::Expiration(value) => {LedgerEntryType::Expiration.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match LedgerEntryType::from_xdr_buffered(read_stream)? {
            ...
            LedgerEntryType::Trustline => Ok(LedgerEntryData::Trustline(TrustLineEntry::from_xdr_buffered(read_stream)?)),
            ...
            LedgerEntryType::ClaimableBalance => Ok(LedgerEntryData::ClaimableBalance(ClaimableBalanceEntry::from_xdr_buffered(read_stream)?)),
            LedgerEntryType::LiquidityPool => Ok(LedgerEntryData::LiquidityPool(LiquidityPoolEntry::from_xdr_buffered(read_stream)?)),
            LedgerEntryType::ContractData => Ok(LedgerEntryData::ContractData(ContractDataEntry::from_xdr_buffered(read_stream)?)),
            LedgerEntryType::ContractCode => Ok(LedgerEntryData::ContractCode(ContractCodeEntry::from_xdr_buffered(read_stream)?)),
...
impl XdrCodec for LedgerEntryExt {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ...
            LedgerEntryExt::V1(value) => {(1 as i32).to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
...
impl XdrCodec for LedgerKey {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            LedgerKey::Account(value) => {LedgerEntryType::Account.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            LedgerKey::Trustline(value) => {LedgerEntryType::Trustline.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            LedgerKey::Offer(value) => {LedgerEntryType::Offer.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            LedgerKey::Data(value) => {LedgerEntryType::Data.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            LedgerKey::ClaimableBalance(value) => {LedgerEntryType::ClaimableBalance.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            LedgerKey::LiquidityPool(value) => {LedgerEntryType::LiquidityPool.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            LedgerKey::ContractData(value) => {LedgerEntryType::ContractData.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            LedgerKey::ContractCode(value) => {LedgerEntryType::ContractCode.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            LedgerKey::ConfigSetting(value) => {LedgerEntryType::ConfigSetting.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            LedgerKey::Expiration(value) => {LedgerEntryType::Expiration.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match LedgerEntryType::from_xdr_buffered(read_stream)? {
            ...
            LedgerEntryType::ClaimableBalance => Ok(LedgerKey::ClaimableBalance(LedgerKeyClaimableBalance::from_xdr_buffered(read_stream)?)),
            LedgerEntryType::LiquidityPool => Ok(LedgerKey::LiquidityPool(LedgerKeyLiquidityPool::from_xdr_buffered(read_stream)?)),
            LedgerEntryType::ContractData => Ok(LedgerKey::ContractData(LedgerKeyContractData::from_xdr_buffered(read_stream)?)),
            LedgerEntryType::ContractCode => Ok(LedgerKey::ContractCode(LedgerKeyContractCode::from_xdr_buffered(read_stream)?)),
            LedgerEntryType::ConfigSetting => Ok(LedgerKey::ConfigSetting(LedgerKeyConfigSetting::from_xdr_buffered(read_stream)?)),
...
impl XdrCodec for StellarValueExt {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ...
            StellarValueExt::StellarValueSigned(value) => {StellarValueType::StellarValueSigned.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match StellarValueType::from_xdr_buffered(read_stream)? {
            ...
            StellarValueType::StellarValueSigned => Ok(StellarValueExt::StellarValueSigned(LedgerCloseValueSignature::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for LedgerHeaderExt {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ...
            LedgerHeaderExt::V1(value) => {(1 as i32).to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
...
impl XdrCodec for LedgerUpgrade {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            LedgerUpgrade::LedgerUpgradeVersion(value) => {LedgerUpgradeType::LedgerUpgradeVersion.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            LedgerUpgrade::LedgerUpgradeBaseFee(value) => {LedgerUpgradeType::LedgerUpgradeBaseFee.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            LedgerUpgrade::LedgerUpgradeMaxTxSetSize(value) => {LedgerUpgradeType::LedgerUpgradeMaxTxSetSize.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            LedgerUpgrade::LedgerUpgradeBaseReserve(value) => {LedgerUpgradeType::LedgerUpgradeBaseReserve.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            LedgerUpgrade::LedgerUpgradeFlags(value) => {LedgerUpgradeType::LedgerUpgradeFlags.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            LedgerUpgrade::LedgerUpgradeConfig(value) => {LedgerUpgradeType::LedgerUpgradeConfig.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            LedgerUpgrade::LedgerUpgradeMaxSorobanTxSetSize(value) => {LedgerUpgradeType::LedgerUpgradeMaxSorobanTxSetSize.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match LedgerUpgradeType::from_xdr_buffered(read_stream)? {
            LedgerUpgradeType::LedgerUpgradeVersion => Ok(LedgerUpgrade::LedgerUpgradeVersion(Uint32::from_xdr_buffered(read_stream)?)),
            LedgerUpgradeType::LedgerUpgradeBaseFee => Ok(LedgerUpgrade::LedgerUpgradeBaseFee(Uint32::from_xdr_buffered(read_stream)?)),
            LedgerUpgradeType::LedgerUpgradeMaxTxSetSize => Ok(LedgerUpgrade::LedgerUpgradeMaxTxSetSize(Uint32::from_xdr_buffered(read_stream)?)),
            LedgerUpgradeType::LedgerUpgradeBaseReserve => Ok(LedgerUpgrade::LedgerUpgradeBaseReserve(Uint32::from_xdr_buffered(read_stream)?)),
            LedgerUpgradeType::LedgerUpgradeFlags => Ok(LedgerUpgrade::LedgerUpgradeFlags(Uint32::from_xdr_buffered(read_stream)?)),
            LedgerUpgradeType::LedgerUpgradeConfig => Ok(LedgerUpgrade::LedgerUpgradeConfig(ConfigUpgradeSetKey::from_xdr_buffered(read_stream)?)),
            LedgerUpgradeType::LedgerUpgradeMaxSorobanTxSetSize => Ok(LedgerUpgrade::LedgerUpgradeMaxSorobanTxSetSize(Uint32::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for BucketEntry {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            BucketEntry::Liveentry(value) => {BucketEntryType::Liveentry.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            BucketEntry::Initentry(value) => {BucketEntryType::Initentry.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            BucketEntry::Deadentry(value) => {BucketEntryType::Deadentry.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            BucketEntry::Metaentry(value) => {BucketEntryType::Metaentry.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
...
impl XdrCodec for TxSetComponent {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            TxSetComponent::TxsetCompTxsMaybeDiscountedFee(value) => {TxSetComponentType::TxsetCompTxsMaybeDiscountedFee.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match TxSetComponentType::from_xdr_buffered(read_stream)? {
            TxSetComponentType::TxsetCompTxsMaybeDiscountedFee => Ok(TxSetComponent::TxsetCompTxsMaybeDiscountedFee(TxSetComponentTxsMaybeDiscountedFee::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for TransactionPhase {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            TransactionPhase::V0(value) => {(0 as i32).to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
...
impl XdrCodec for GeneralizedTransactionSet {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            GeneralizedTransactionSet::V1(value) => {(1 as i32).to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
...
impl XdrCodec for TransactionHistoryEntryExt {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ...
            TransactionHistoryEntryExt::V1(value) => {(1 as i32).to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
...
impl XdrCodec for ScpHistoryEntry {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ScpHistoryEntry::V0(value) => {(0 as i32).to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
...
impl XdrCodec for LedgerEntryChange {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            LedgerEntryChange::LedgerEntryCreated(value) => {LedgerEntryChangeType::LedgerEntryCreated.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            LedgerEntryChange::LedgerEntryUpdated(value) => {LedgerEntryChangeType::LedgerEntryUpdated.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            LedgerEntryChange::LedgerEntryRemoved(value) => {LedgerEntryChangeType::LedgerEntryRemoved.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            LedgerEntryChange::LedgerEntryState(value) => {LedgerEntryChangeType::LedgerEntryState.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match LedgerEntryChangeType::from_xdr_buffered(read_stream)? {
            LedgerEntryChangeType::LedgerEntryCreated => Ok(LedgerEntryChange::LedgerEntryCreated(LedgerEntry::from_xdr_buffered(read_stream)?)),
            LedgerEntryChangeType::LedgerEntryUpdated => Ok(LedgerEntryChange::LedgerEntryUpdated(LedgerEntry::from_xdr_buffered(read_stream)?)),
            LedgerEntryChangeType::LedgerEntryRemoved => Ok(LedgerEntryChange::LedgerEntryRemoved(LedgerKey::from_xdr_buffered(read_stream)?)),
            LedgerEntryChangeType::LedgerEntryState => Ok(LedgerEntryChange::LedgerEntryState(LedgerEntry::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for ContractEventBody {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ContractEventBody::V0(value) => {(0 as i32).to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
...
impl XdrCodec for TransactionMeta {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            TransactionMeta::V0(value) => {(0 as i32).to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            TransactionMeta::V1(value) => {(1 as i32).to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            TransactionMeta::V2(value) => {(2 as i32).to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            TransactionMeta::V3(value) => {(3 as i32).to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
...
impl XdrCodec for LedgerCloseMeta {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            LedgerCloseMeta::V0(value) => {(0 as i32).to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            LedgerCloseMeta::V1(value) => {(1 as i32).to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            LedgerCloseMeta::V2(value) => {(2 as i32).to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
...
impl XdrCodec for PeerAddressIp {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            PeerAddressIp::IPv4(value) => {IpAddrType::IPv4.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            PeerAddressIp::IPv6(value) => {IpAddrType::IPv6.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
...
impl XdrCodec for SurveyResponseBody {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            SurveyResponseBody::SurveyTopologyResponseV0(value) => {SurveyMessageResponseType::SurveyTopologyResponseV0.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            SurveyResponseBody::SurveyTopologyResponseV1(value) => {SurveyMessageResponseType::SurveyTopologyResponseV1.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match SurveyMessageResponseType::from_xdr_buffered(read_stream)? {
            SurveyMessageResponseType::SurveyTopologyResponseV0 => Ok(SurveyResponseBody::SurveyTopologyResponseV0(TopologyResponseBodyV0::from_xdr_buffered(read_stream)?)),
            SurveyMessageResponseType::SurveyTopologyResponseV1 => Ok(SurveyResponseBody::SurveyTopologyResponseV1(TopologyResponseBodyV1::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for StellarMessage {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            StellarMessage::ErrorMsg(value) => {MessageType::ErrorMsg.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            StellarMessage::Hello(value) => {MessageType::Hello.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            StellarMessage::Auth(value) => {MessageType::Auth.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            StellarMessage::DontHave(value) => {MessageType::DontHave.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            StellarMessage::GetPeers => MessageType::GetPeers.to_xdr_buffered(write_stream),
            StellarMessage::Peers(value) => {MessageType::Peers.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            StellarMessage::GetTxSet(value) => {MessageType::GetTxSet.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            StellarMessage::TxSet(value) => {MessageType::TxSet.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            StellarMessage::GeneralizedTxSet(value) => {MessageType::GeneralizedTxSet.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            StellarMessage::Transaction(value) => {MessageType::Transaction.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            StellarMessage::SurveyRequest(value) => {MessageType::SurveyRequest.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            StellarMessage::SurveyResponse(value) => {MessageType::SurveyResponse.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            StellarMessage::GetScpQuorumset(value) => {MessageType::GetScpQuorumset.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            StellarMessage::ScpQuorumset(value) => {MessageType::ScpQuorumset.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            StellarMessage::ScpMessage(value) => {MessageType::ScpMessage.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            StellarMessage::GetScpState(value) => {MessageType::GetScpState.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            StellarMessage::SendMore(value) => {MessageType::SendMore.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            StellarMessage::SendMoreExtended(value) => {MessageType::SendMoreExtended.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            StellarMessage::FloodAdvert(value) => {MessageType::FloodAdvert.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            StellarMessage::FloodDemand(value) => {MessageType::FloodDemand.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match MessageType::from_xdr_buffered(read_stream)? {
            ...
            MessageType::Peers => Ok(StellarMessage::Peers(LimitedVarArray::<PeerAddress, 100>::from_xdr_buffered(read_stream)?)),
            ...
            MessageType::GeneralizedTxSet => Ok(StellarMessage::GeneralizedTxSet(GeneralizedTransactionSet::from_xdr_buffered(read_stream)?)),
            MessageType::Transaction => Ok(StellarMessage::Transaction(TransactionEnvelope::from_xdr_buffered(read_stream)?)),
            MessageType::SurveyRequest => Ok(StellarMessage::SurveyRequest(SignedSurveyRequestMessage::from_xdr_buffered(read_stream)?)),
            MessageType::SurveyResponse => Ok(StellarMessage::SurveyResponse(SignedSurveyResponseMessage::from_xdr_buffered(read_stream)?)),
            MessageType::GetScpQuorumset => Ok(StellarMessage::GetScpQuorumset(Uint256::from_xdr_buffered(read_stream)?)),
            MessageType::ScpQuorumset => Ok(StellarMessage::ScpQuorumset(ScpQuorumSet::from_xdr_buffered(read_stream)?)),
            ...
            MessageType::SendMoreExtended => Ok(StellarMessage::SendMoreExtended(SendMoreExtended::from_xdr_buffered(read_stream)?)),
...
impl XdrCodec for AuthenticatedMessage {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            AuthenticatedMessage::V0(value) => {(0 as Uint32).to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
...
impl XdrCodec for LiquidityPoolParameters {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            LiquidityPoolParameters::LiquidityPoolConstantProduct(value) => {LiquidityPoolType::LiquidityPoolConstantProduct.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match LiquidityPoolType::from_xdr_buffered(read_stream)? {
            LiquidityPoolType::LiquidityPoolConstantProduct => Ok(LiquidityPoolParameters::LiquidityPoolConstantProduct(LiquidityPoolConstantProductParameters::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for MuxedAccount {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            MuxedAccount::KeyTypeEd25519(value) => {CryptoKeyType::KeyTypeEd25519.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            MuxedAccount::KeyTypeMuxedEd25519(value) => {CryptoKeyType::KeyTypeMuxedEd25519.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match CryptoKeyType::from_xdr_buffered(read_stream)? {
            ...
            CryptoKeyType::KeyTypeMuxedEd25519 => Ok(MuxedAccount::KeyTypeMuxedEd25519(MuxedAccountMed25519::from_xdr_buffered(read_stream)?)),
...
impl XdrCodec for ChangeTrustAsset {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ...
            ChangeTrustAsset::AssetTypeCreditAlphanum4(value) => {AssetType::AssetTypeCreditAlphanum4.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ChangeTrustAsset::AssetTypeCreditAlphanum12(value) => {AssetType::AssetTypeCreditAlphanum12.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ChangeTrustAsset::AssetTypePoolShare(value) => {AssetType::AssetTypePoolShare.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match AssetType::from_xdr_buffered(read_stream)? {
            ...
            AssetType::AssetTypeCreditAlphanum4 => Ok(ChangeTrustAsset::AssetTypeCreditAlphanum4(AlphaNum4::from_xdr_buffered(read_stream)?)),
            AssetType::AssetTypeCreditAlphanum12 => Ok(ChangeTrustAsset::AssetTypeCreditAlphanum12(AlphaNum12::from_xdr_buffered(read_stream)?)),
            AssetType::AssetTypePoolShare => Ok(ChangeTrustAsset::AssetTypePoolShare(LiquidityPoolParameters::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for RevokeSponsorshipOp {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            RevokeSponsorshipOp::RevokeSponsorshipLedgerEntry(value) => {RevokeSponsorshipType::RevokeSponsorshipLedgerEntry.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            RevokeSponsorshipOp::RevokeSponsorshipSigner(value) => {RevokeSponsorshipType::RevokeSponsorshipSigner.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match RevokeSponsorshipType::from_xdr_buffered(read_stream)? {
            RevokeSponsorshipType::RevokeSponsorshipLedgerEntry => Ok(RevokeSponsorshipOp::RevokeSponsorshipLedgerEntry(LedgerKey::from_xdr_buffered(read_stream)?)),
            RevokeSponsorshipType::RevokeSponsorshipSigner => Ok(RevokeSponsorshipOp::RevokeSponsorshipSigner(RevokeSponsorshipOpSigner::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for ContractIdPreimage {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ContractIdPreimage::ContractIdPreimageFromAddress(value) => {ContractIdPreimageType::ContractIdPreimageFromAddress.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ContractIdPreimage::ContractIdPreimageFromAsset(value) => {ContractIdPreimageType::ContractIdPreimageFromAsset.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match ContractIdPreimageType::from_xdr_buffered(read_stream)? {
            ContractIdPreimageType::ContractIdPreimageFromAddress => Ok(ContractIdPreimage::ContractIdPreimageFromAddress(ContractIdPreimageFromAddress::from_xdr_buffered(read_stream)?)),
            ContractIdPreimageType::ContractIdPreimageFromAsset => Ok(ContractIdPreimage::ContractIdPreimageFromAsset(Asset::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for HostFunction {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            HostFunction::HostFunctionTypeInvokeContract(value) => {HostFunctionType::HostFunctionTypeInvokeContract.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            HostFunction::HostFunctionTypeCreateContract(value) => {HostFunctionType::HostFunctionTypeCreateContract.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            HostFunction::HostFunctionTypeUploadContractWasm(value) => {HostFunctionType::HostFunctionTypeUploadContractWasm.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match HostFunctionType::from_xdr_buffered(read_stream)? {
            HostFunctionType::HostFunctionTypeInvokeContract => Ok(HostFunction::HostFunctionTypeInvokeContract(InvokeContractArgs::from_xdr_buffered(read_stream)?)),
            HostFunctionType::HostFunctionTypeCreateContract => Ok(HostFunction::HostFunctionTypeCreateContract(CreateContractArgs::from_xdr_buffered(read_stream)?)),
            HostFunctionType::HostFunctionTypeUploadContractWasm => Ok(HostFunction::HostFunctionTypeUploadContractWasm(UnlimitedVarOpaque::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for SorobanAuthorizedFunction {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            SorobanAuthorizedFunction::SorobanAuthorizedFunctionTypeContractFn(value) => {SorobanAuthorizedFunctionType::SorobanAuthorizedFunctionTypeContractFn.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            SorobanAuthorizedFunction::SorobanAuthorizedFunctionTypeCreateContractHostFn(value) => {SorobanAuthorizedFunctionType::SorobanAuthorizedFunctionTypeCreateContractHostFn.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match SorobanAuthorizedFunctionType::from_xdr_buffered(read_stream)? {
            SorobanAuthorizedFunctionType::SorobanAuthorizedFunctionTypeContractFn => Ok(SorobanAuthorizedFunction::SorobanAuthorizedFunctionTypeContractFn(InvokeContractArgs::from_xdr_buffered(read_stream)?)),
            SorobanAuthorizedFunctionType::SorobanAuthorizedFunctionTypeCreateContractHostFn => Ok(SorobanAuthorizedFunction::SorobanAuthorizedFunctionTypeCreateContractHostFn(CreateContractArgs::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for SorobanCredentials {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            SorobanCredentials::SorobanCredentialsSourceAccount => SorobanCredentialsType::SorobanCredentialsSourceAccount.to_xdr_buffered(write_stream),
            SorobanCredentials::SorobanCredentialsAddress(value) => {SorobanCredentialsType::SorobanCredentialsAddress.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match SorobanCredentialsType::from_xdr_buffered(read_stream)? {
            SorobanCredentialsType::SorobanCredentialsSourceAccount => Ok(SorobanCredentials::SorobanCredentialsSourceAccount),
            SorobanCredentialsType::SorobanCredentialsAddress => Ok(SorobanCredentials::SorobanCredentialsAddress(SorobanAddressCredentials::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for OperationBody {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            OperationBody::CreateAccount(value) => {OperationType::CreateAccount.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationBody::Payment(value) => {OperationType::Payment.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationBody::PathPaymentStrictReceive(value) => {OperationType::PathPaymentStrictReceive.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationBody::ManageSellOffer(value) => {OperationType::ManageSellOffer.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationBody::CreatePassiveSellOffer(value) => {OperationType::CreatePassiveSellOffer.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationBody::SetOptions(value) => {OperationType::SetOptions.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationBody::ChangeTrust(value) => {OperationType::ChangeTrust.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationBody::AllowTrust(value) => {OperationType::AllowTrust.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationBody::AccountMerge(value) => {OperationType::AccountMerge.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationBody::Inflation => OperationType::Inflation.to_xdr_buffered(write_stream),
            OperationBody::ManageData(value) => {OperationType::ManageData.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationBody::BumpSequence(value) => {OperationType::BumpSequence.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationBody::ManageBuyOffer(value) => {OperationType::ManageBuyOffer.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationBody::PathPaymentStrictSend(value) => {OperationType::PathPaymentStrictSend.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationBody::CreateClaimableBalance(value) => {OperationType::CreateClaimableBalance.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationBody::ClaimClaimableBalance(value) => {OperationType::ClaimClaimableBalance.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationBody::BeginSponsoringFutureReserves(value) => {OperationType::BeginSponsoringFutureReserves.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationBody::EndSponsoringFutureReserves => OperationType::EndSponsoringFutureReserves.to_xdr_buffered(write_stream),
            OperationBody::RevokeSponsorship(value) => {OperationType::RevokeSponsorship.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationBody::Clawback(value) => {OperationType::Clawback.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationBody::ClawbackClaimableBalance(value) => {OperationType::ClawbackClaimableBalance.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationBody::SetTrustLineFlags(value) => {OperationType::SetTrustLineFlags.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationBody::LiquidityPoolDeposit(value) => {OperationType::LiquidityPoolDeposit.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationBody::LiquidityPoolWithdraw(value) => {OperationType::LiquidityPoolWithdraw.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationBody::InvokeHostFunction(value) => {OperationType::InvokeHostFunction.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationBody::BumpFootprintExpiration(value) => {OperationType::BumpFootprintExpiration.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationBody::RestoreFootprint(value) => {OperationType::RestoreFootprint.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match OperationType::from_xdr_buffered(read_stream)? {
            OperationType::CreateAccount => Ok(OperationBody::CreateAccount(CreateAccountOp::from_xdr_buffered(read_stream)?)),
            OperationType::Payment => Ok(OperationBody::Payment(PaymentOp::from_xdr_buffered(read_stream)?)),
            OperationType::PathPaymentStrictReceive => Ok(OperationBody::PathPaymentStrictReceive(PathPaymentStrictReceiveOp::from_xdr_buffered(read_stream)?)),
            OperationType::ManageSellOffer => Ok(OperationBody::ManageSellOffer(ManageSellOfferOp::from_xdr_buffered(read_stream)?)),
            OperationType::CreatePassiveSellOffer => Ok(OperationBody::CreatePassiveSellOffer(CreatePassiveSellOfferOp::from_xdr_buffered(read_stream)?)),
            OperationType::SetOptions => Ok(OperationBody::SetOptions(SetOptionsOp::from_xdr_buffered(read_stream)?)),
            OperationType::ChangeTrust => Ok(OperationBody::ChangeTrust(ChangeTrustOp::from_xdr_buffered(read_stream)?)),
            OperationType::AllowTrust => Ok(OperationBody::AllowTrust(AllowTrustOp::from_xdr_buffered(read_stream)?)),
            OperationType::AccountMerge => Ok(OperationBody::AccountMerge(MuxedAccount::from_xdr_buffered(read_stream)?)),
            ...
            OperationType::BumpSequence => Ok(OperationBody::BumpSequence(BumpSequenceOp::from_xdr_buffered(read_stream)?)),
            OperationType::ManageBuyOffer => Ok(OperationBody::ManageBuyOffer(ManageBuyOfferOp::from_xdr_buffered(read_stream)?)),
            OperationType::PathPaymentStrictSend => Ok(OperationBody::PathPaymentStrictSend(PathPaymentStrictSendOp::from_xdr_buffered(read_stream)?)),
            OperationType::CreateClaimableBalance => Ok(OperationBody::CreateClaimableBalance(CreateClaimableBalanceOp::from_xdr_buffered(read_stream)?)),
            OperationType::ClaimClaimableBalance => Ok(OperationBody::ClaimClaimableBalance(ClaimClaimableBalanceOp::from_xdr_buffered(read_stream)?)),
            OperationType::BeginSponsoringFutureReserves => Ok(OperationBody::BeginSponsoringFutureReserves(BeginSponsoringFutureReservesOp::from_xdr_buffered(read_stream)?)),
            OperationType::EndSponsoringFutureReserves => Ok(OperationBody::EndSponsoringFutureReserves),
            OperationType::RevokeSponsorship => Ok(OperationBody::RevokeSponsorship(RevokeSponsorshipOp::from_xdr_buffered(read_stream)?)),
            OperationType::Clawback => Ok(OperationBody::Clawback(ClawbackOp::from_xdr_buffered(read_stream)?)),
            OperationType::ClawbackClaimableBalance => Ok(OperationBody::ClawbackClaimableBalance(ClawbackClaimableBalanceOp::from_xdr_buffered(read_stream)?)),
            OperationType::SetTrustLineFlags => Ok(OperationBody::SetTrustLineFlags(SetTrustLineFlagsOp::from_xdr_buffered(read_stream)?)),
            OperationType::LiquidityPoolDeposit => Ok(OperationBody::LiquidityPoolDeposit(LiquidityPoolDepositOp::from_xdr_buffered(read_stream)?)),
            OperationType::LiquidityPoolWithdraw => Ok(OperationBody::LiquidityPoolWithdraw(LiquidityPoolWithdrawOp::from_xdr_buffered(read_stream)?)),
            OperationType::InvokeHostFunction => Ok(OperationBody::InvokeHostFunction(InvokeHostFunctionOp::from_xdr_buffered(read_stream)?)),
            OperationType::BumpFootprintExpiration => Ok(OperationBody::BumpFootprintExpiration(BumpFootprintExpirationOp::from_xdr_buffered(read_stream)?)),
            OperationType::RestoreFootprint => Ok(OperationBody::RestoreFootprint(RestoreFootprintOp::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for HashIdPreimage {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            HashIdPreimage::EnvelopeTypeOpId(value) => {EnvelopeType::EnvelopeTypeOpId.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            HashIdPreimage::EnvelopeTypePoolRevokeOpId(value) => {EnvelopeType::EnvelopeTypePoolRevokeOpId.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            HashIdPreimage::EnvelopeTypeContractId(value) => {EnvelopeType::EnvelopeTypeContractId.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            HashIdPreimage::EnvelopeTypeSorobanAuthorization(value) => {EnvelopeType::EnvelopeTypeSorobanAuthorization.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match EnvelopeType::from_xdr_buffered(read_stream)? {
            EnvelopeType::EnvelopeTypeOpId => Ok(HashIdPreimage::EnvelopeTypeOpId(HashIdPreimageOperationId::from_xdr_buffered(read_stream)?)),
            EnvelopeType::EnvelopeTypePoolRevokeOpId => Ok(HashIdPreimage::EnvelopeTypePoolRevokeOpId(HashIdPreimageRevokeId::from_xdr_buffered(read_stream)?)),
            EnvelopeType::EnvelopeTypeContractId => Ok(HashIdPreimage::EnvelopeTypeContractId(HashIdPreimageContractId::from_xdr_buffered(read_stream)?)),
            EnvelopeType::EnvelopeTypeSorobanAuthorization => Ok(HashIdPreimage::EnvelopeTypeSorobanAuthorization(HashIdPreimageSorobanAuthorization::from_xdr_buffered(read_stream)?)),
...
impl XdrCodec for Memo {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ...
            Memo::MemoText(value) => {MemoType::MemoText.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            Memo::MemoId(value) => {MemoType::MemoId.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            Memo::MemoHash(value) => {MemoType::MemoHash.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            Memo::MemoReturn(value) => {MemoType::MemoReturn.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
...
impl XdrCodec for Preconditions {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ...
            Preconditions::PrecondTime(value) => {PreconditionType::PrecondTime.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            Preconditions::PrecondV2(value) => {PreconditionType::PrecondV2.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match PreconditionType::from_xdr_buffered(read_stream)? {
            ...
            PreconditionType::PrecondTime => Ok(Preconditions::PrecondTime(TimeBounds::from_xdr_buffered(read_stream)?)),
            PreconditionType::PrecondV2 => Ok(Preconditions::PrecondV2(PreconditionsV2::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for TransactionExt {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ...
            TransactionExt::V1(value) => {(1 as i32).to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
...
impl XdrCodec for FeeBumpTransactionInnerTx {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            FeeBumpTransactionInnerTx::EnvelopeTypeTx(value) => {EnvelopeType::EnvelopeTypeTx.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match EnvelopeType::from_xdr_buffered(read_stream)? {
            EnvelopeType::EnvelopeTypeTx => Ok(FeeBumpTransactionInnerTx::EnvelopeTypeTx(TransactionV1Envelope::from_xdr_buffered(read_stream)?)),
...
impl XdrCodec for TransactionEnvelope {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            TransactionEnvelope::EnvelopeTypeTxV0(value) => {EnvelopeType::EnvelopeTypeTxV0.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            TransactionEnvelope::EnvelopeTypeTx(value) => {EnvelopeType::EnvelopeTypeTx.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            TransactionEnvelope::EnvelopeTypeTxFeeBump(value) => {EnvelopeType::EnvelopeTypeTxFeeBump.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match EnvelopeType::from_xdr_buffered(read_stream)? {
            EnvelopeType::EnvelopeTypeTxV0 => Ok(TransactionEnvelope::EnvelopeTypeTxV0(TransactionV0Envelope::from_xdr_buffered(read_stream)?)),
            EnvelopeType::EnvelopeTypeTx => Ok(TransactionEnvelope::EnvelopeTypeTx(TransactionV1Envelope::from_xdr_buffered(read_stream)?)),
            EnvelopeType::EnvelopeTypeTxFeeBump => Ok(TransactionEnvelope::EnvelopeTypeTxFeeBump(FeeBumpTransactionEnvelope::from_xdr_buffered(read_stream)?)),
...
impl XdrCodec for TransactionSignaturePayloadTaggedTransaction {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            TransactionSignaturePayloadTaggedTransaction::EnvelopeTypeTx(value) => {EnvelopeType::EnvelopeTypeTx.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            TransactionSignaturePayloadTaggedTransaction::EnvelopeTypeTxFeeBump(value) => {EnvelopeType::EnvelopeTypeTxFeeBump.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match EnvelopeType::from_xdr_buffered(read_stream)? {
            EnvelopeType::EnvelopeTypeTx => Ok(TransactionSignaturePayloadTaggedTransaction::EnvelopeTypeTx(Transaction::from_xdr_buffered(read_stream)?)),
            EnvelopeType::EnvelopeTypeTxFeeBump => Ok(TransactionSignaturePayloadTaggedTransaction::EnvelopeTypeTxFeeBump(FeeBumpTransaction::from_xdr_buffered(read_stream)?)),
...
impl XdrCodec for ClaimAtom {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ClaimAtom::ClaimAtomTypeV0(value) => {ClaimAtomType::ClaimAtomTypeV0.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ClaimAtom::ClaimAtomTypeOrderBook(value) => {ClaimAtomType::ClaimAtomTypeOrderBook.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ClaimAtom::ClaimAtomTypeLiquidityPool(value) => {ClaimAtomType::ClaimAtomTypeLiquidityPool.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match ClaimAtomType::from_xdr_buffered(read_stream)? {
            ClaimAtomType::ClaimAtomTypeV0 => Ok(ClaimAtom::ClaimAtomTypeV0(ClaimOfferAtomV0::from_xdr_buffered(read_stream)?)),
            ClaimAtomType::ClaimAtomTypeOrderBook => Ok(ClaimAtom::ClaimAtomTypeOrderBook(ClaimOfferAtom::from_xdr_buffered(read_stream)?)),
            ClaimAtomType::ClaimAtomTypeLiquidityPool => Ok(ClaimAtom::ClaimAtomTypeLiquidityPool(ClaimLiquidityAtom::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for CreateAccountResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            CreateAccountResult::CreateAccountSuccess => CreateAccountResultCode::CreateAccountSuccess.to_xdr_buffered(write_stream),
            CreateAccountResult::CreateAccountMalformed => CreateAccountResultCode::CreateAccountMalformed.to_xdr_buffered(write_stream),
            CreateAccountResult::CreateAccountUnderfunded => CreateAccountResultCode::CreateAccountUnderfunded.to_xdr_buffered(write_stream),
            CreateAccountResult::CreateAccountLowReserve => CreateAccountResultCode::CreateAccountLowReserve.to_xdr_buffered(write_stream),
            CreateAccountResult::CreateAccountAlreadyExist => CreateAccountResultCode::CreateAccountAlreadyExist.to_xdr_buffered(write_stream),
        }
    }
...
impl XdrCodec for PaymentResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ...
            PaymentResult::PaymentSrcNotAuthorized => PaymentResultCode::PaymentSrcNotAuthorized.to_xdr_buffered(write_stream),
            PaymentResult::PaymentNoDestination => PaymentResultCode::PaymentNoDestination.to_xdr_buffered(write_stream),
            PaymentResult::PaymentNoTrust => PaymentResultCode::PaymentNoTrust.to_xdr_buffered(write_stream),
            PaymentResult::PaymentNotAuthorized => PaymentResultCode::PaymentNotAuthorized.to_xdr_buffered(write_stream),
...
impl XdrCodec for PathPaymentStrictReceiveResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            PathPaymentStrictReceiveResult::PathPaymentStrictReceiveSuccess(value) => {PathPaymentStrictReceiveResultCode::PathPaymentStrictReceiveSuccess.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            PathPaymentStrictReceiveResult::PathPaymentStrictReceiveMalformed => PathPaymentStrictReceiveResultCode::PathPaymentStrictReceiveMalformed.to_xdr_buffered(write_stream),
            PathPaymentStrictReceiveResult::PathPaymentStrictReceiveUnderfunded => PathPaymentStrictReceiveResultCode::PathPaymentStrictReceiveUnderfunded.to_xdr_buffered(write_stream),
            PathPaymentStrictReceiveResult::PathPaymentStrictReceiveSrcNoTrust => PathPaymentStrictReceiveResultCode::PathPaymentStrictReceiveSrcNoTrust.to_xdr_buffered(write_stream),
            PathPaymentStrictReceiveResult::PathPaymentStrictReceiveSrcNotAuthorized => PathPaymentStrictReceiveResultCode::PathPaymentStrictReceiveSrcNotAuthorized.to_xdr_buffered(write_stream),
            PathPaymentStrictReceiveResult::PathPaymentStrictReceiveNoDestination => PathPaymentStrictReceiveResultCode::PathPaymentStrictReceiveNoDestination.to_xdr_buffered(write_stream),
            PathPaymentStrictReceiveResult::PathPaymentStrictReceiveNoTrust => PathPaymentStrictReceiveResultCode::PathPaymentStrictReceiveNoTrust.to_xdr_buffered(write_stream),
            PathPaymentStrictReceiveResult::PathPaymentStrictReceiveNotAuthorized => PathPaymentStrictReceiveResultCode::PathPaymentStrictReceiveNotAuthorized.to_xdr_buffered(write_stream),
            PathPaymentStrictReceiveResult::PathPaymentStrictReceiveLineFull => PathPaymentStrictReceiveResultCode::PathPaymentStrictReceiveLineFull.to_xdr_buffered(write_stream),
            PathPaymentStrictReceiveResult::PathPaymentStrictReceiveNoIssuer(value) => {PathPaymentStrictReceiveResultCode::PathPaymentStrictReceiveNoIssuer.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            PathPaymentStrictReceiveResult::PathPaymentStrictReceiveTooFewOffers => PathPaymentStrictReceiveResultCode::PathPaymentStrictReceiveTooFewOffers.to_xdr_buffered(write_stream),
            PathPaymentStrictReceiveResult::PathPaymentStrictReceiveOfferCrossSelf => PathPaymentStrictReceiveResultCode::PathPaymentStrictReceiveOfferCrossSelf.to_xdr_buffered(write_stream),
            PathPaymentStrictReceiveResult::PathPaymentStrictReceiveOverSendmax => PathPaymentStrictReceiveResultCode::PathPaymentStrictReceiveOverSendmax.to_xdr_buffered(write_stream),
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match PathPaymentStrictReceiveResultCode::from_xdr_buffered(read_stream)? {
            PathPaymentStrictReceiveResultCode::PathPaymentStrictReceiveSuccess => Ok(PathPaymentStrictReceiveResult::PathPaymentStrictReceiveSuccess(PathPaymentStrictReceiveResultSuccess::from_xdr_buffered(read_stream)?)),
            PathPaymentStrictReceiveResultCode::PathPaymentStrictReceiveMalformed => Ok(PathPaymentStrictReceiveResult::PathPaymentStrictReceiveMalformed),
            PathPaymentStrictReceiveResultCode::PathPaymentStrictReceiveUnderfunded => Ok(PathPaymentStrictReceiveResult::PathPaymentStrictReceiveUnderfunded),
            PathPaymentStrictReceiveResultCode::PathPaymentStrictReceiveSrcNoTrust => Ok(PathPaymentStrictReceiveResult::PathPaymentStrictReceiveSrcNoTrust),
            PathPaymentStrictReceiveResultCode::PathPaymentStrictReceiveSrcNotAuthorized => Ok(PathPaymentStrictReceiveResult::PathPaymentStrictReceiveSrcNotAuthorized),
            PathPaymentStrictReceiveResultCode::PathPaymentStrictReceiveNoDestination => Ok(PathPaymentStrictReceiveResult::PathPaymentStrictReceiveNoDestination),
            PathPaymentStrictReceiveResultCode::PathPaymentStrictReceiveNoTrust => Ok(PathPaymentStrictReceiveResult::PathPaymentStrictReceiveNoTrust),
            PathPaymentStrictReceiveResultCode::PathPaymentStrictReceiveNotAuthorized => Ok(PathPaymentStrictReceiveResult::PathPaymentStrictReceiveNotAuthorized),
            PathPaymentStrictReceiveResultCode::PathPaymentStrictReceiveLineFull => Ok(PathPaymentStrictReceiveResult::PathPaymentStrictReceiveLineFull),
            PathPaymentStrictReceiveResultCode::PathPaymentStrictReceiveNoIssuer => Ok(PathPaymentStrictReceiveResult::PathPaymentStrictReceiveNoIssuer(Asset::from_xdr_buffered(read_stream)?)),
            PathPaymentStrictReceiveResultCode::PathPaymentStrictReceiveTooFewOffers => Ok(PathPaymentStrictReceiveResult::PathPaymentStrictReceiveTooFewOffers),
            PathPaymentStrictReceiveResultCode::PathPaymentStrictReceiveOfferCrossSelf => Ok(PathPaymentStrictReceiveResult::PathPaymentStrictReceiveOfferCrossSelf),
            PathPaymentStrictReceiveResultCode::PathPaymentStrictReceiveOverSendmax => Ok(PathPaymentStrictReceiveResult::PathPaymentStrictReceiveOverSendmax),
        }
    }
}
...
impl XdrCodec for PathPaymentStrictSendResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            PathPaymentStrictSendResult::PathPaymentStrictSendSuccess(value) => {PathPaymentStrictSendResultCode::PathPaymentStrictSendSuccess.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            PathPaymentStrictSendResult::PathPaymentStrictSendMalformed => PathPaymentStrictSendResultCode::PathPaymentStrictSendMalformed.to_xdr_buffered(write_stream),
            PathPaymentStrictSendResult::PathPaymentStrictSendUnderfunded => PathPaymentStrictSendResultCode::PathPaymentStrictSendUnderfunded.to_xdr_buffered(write_stream),
            PathPaymentStrictSendResult::PathPaymentStrictSendSrcNoTrust => PathPaymentStrictSendResultCode::PathPaymentStrictSendSrcNoTrust.to_xdr_buffered(write_stream),
            PathPaymentStrictSendResult::PathPaymentStrictSendSrcNotAuthorized => PathPaymentStrictSendResultCode::PathPaymentStrictSendSrcNotAuthorized.to_xdr_buffered(write_stream),
            PathPaymentStrictSendResult::PathPaymentStrictSendNoDestination => PathPaymentStrictSendResultCode::PathPaymentStrictSendNoDestination.to_xdr_buffered(write_stream),
            PathPaymentStrictSendResult::PathPaymentStrictSendNoTrust => PathPaymentStrictSendResultCode::PathPaymentStrictSendNoTrust.to_xdr_buffered(write_stream),
            PathPaymentStrictSendResult::PathPaymentStrictSendNotAuthorized => PathPaymentStrictSendResultCode::PathPaymentStrictSendNotAuthorized.to_xdr_buffered(write_stream),
            PathPaymentStrictSendResult::PathPaymentStrictSendLineFull => PathPaymentStrictSendResultCode::PathPaymentStrictSendLineFull.to_xdr_buffered(write_stream),
            PathPaymentStrictSendResult::PathPaymentStrictSendNoIssuer(value) => {PathPaymentStrictSendResultCode::PathPaymentStrictSendNoIssuer.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            PathPaymentStrictSendResult::PathPaymentStrictSendTooFewOffers => PathPaymentStrictSendResultCode::PathPaymentStrictSendTooFewOffers.to_xdr_buffered(write_stream),
            PathPaymentStrictSendResult::PathPaymentStrictSendOfferCrossSelf => PathPaymentStrictSendResultCode::PathPaymentStrictSendOfferCrossSelf.to_xdr_buffered(write_stream),
            PathPaymentStrictSendResult::PathPaymentStrictSendUnderDestmin => PathPaymentStrictSendResultCode::PathPaymentStrictSendUnderDestmin.to_xdr_buffered(write_stream),
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match PathPaymentStrictSendResultCode::from_xdr_buffered(read_stream)? {
            PathPaymentStrictSendResultCode::PathPaymentStrictSendSuccess => Ok(PathPaymentStrictSendResult::PathPaymentStrictSendSuccess(PathPaymentStrictSendResultSuccess::from_xdr_buffered(read_stream)?)),
            PathPaymentStrictSendResultCode::PathPaymentStrictSendMalformed => Ok(PathPaymentStrictSendResult::PathPaymentStrictSendMalformed),
            PathPaymentStrictSendResultCode::PathPaymentStrictSendUnderfunded => Ok(PathPaymentStrictSendResult::PathPaymentStrictSendUnderfunded),
            PathPaymentStrictSendResultCode::PathPaymentStrictSendSrcNoTrust => Ok(PathPaymentStrictSendResult::PathPaymentStrictSendSrcNoTrust),
            PathPaymentStrictSendResultCode::PathPaymentStrictSendSrcNotAuthorized => Ok(PathPaymentStrictSendResult::PathPaymentStrictSendSrcNotAuthorized),
            PathPaymentStrictSendResultCode::PathPaymentStrictSendNoDestination => Ok(PathPaymentStrictSendResult::PathPaymentStrictSendNoDestination),
            PathPaymentStrictSendResultCode::PathPaymentStrictSendNoTrust => Ok(PathPaymentStrictSendResult::PathPaymentStrictSendNoTrust),
            PathPaymentStrictSendResultCode::PathPaymentStrictSendNotAuthorized => Ok(PathPaymentStrictSendResult::PathPaymentStrictSendNotAuthorized),
            PathPaymentStrictSendResultCode::PathPaymentStrictSendLineFull => Ok(PathPaymentStrictSendResult::PathPaymentStrictSendLineFull),
            PathPaymentStrictSendResultCode::PathPaymentStrictSendNoIssuer => Ok(PathPaymentStrictSendResult::PathPaymentStrictSendNoIssuer(Asset::from_xdr_buffered(read_stream)?)),
            PathPaymentStrictSendResultCode::PathPaymentStrictSendTooFewOffers => Ok(PathPaymentStrictSendResult::PathPaymentStrictSendTooFewOffers),
            PathPaymentStrictSendResultCode::PathPaymentStrictSendOfferCrossSelf => Ok(PathPaymentStrictSendResult::PathPaymentStrictSendOfferCrossSelf),
            PathPaymentStrictSendResultCode::PathPaymentStrictSendUnderDestmin => Ok(PathPaymentStrictSendResult::PathPaymentStrictSendUnderDestmin),
        }
    }
}
...
impl XdrCodec for ManageOfferSuccessResultOffer {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ManageOfferSuccessResultOffer::ManageOfferCreated(value) => {ManageOfferEffect::ManageOfferCreated.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ManageOfferSuccessResultOffer::ManageOfferUpdated(value) => {ManageOfferEffect::ManageOfferUpdated.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ManageOfferSuccessResultOffer::ManageOfferDeleted => ManageOfferEffect::ManageOfferDeleted.to_xdr_buffered(write_stream),
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match ManageOfferEffect::from_xdr_buffered(read_stream)? {
            ManageOfferEffect::ManageOfferCreated => Ok(ManageOfferSuccessResultOffer::ManageOfferCreated(OfferEntry::from_xdr_buffered(read_stream)?)),
            ManageOfferEffect::ManageOfferUpdated => Ok(ManageOfferSuccessResultOffer::ManageOfferUpdated(OfferEntry::from_xdr_buffered(read_stream)?)),
...
impl XdrCodec for ManageSellOfferResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ManageSellOfferResult::ManageSellOfferSuccess(value) => {ManageSellOfferResultCode::ManageSellOfferSuccess.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ManageSellOfferResult::ManageSellOfferMalformed => ManageSellOfferResultCode::ManageSellOfferMalformed.to_xdr_buffered(write_stream),
            ManageSellOfferResult::ManageSellOfferSellNoTrust => ManageSellOfferResultCode::ManageSellOfferSellNoTrust.to_xdr_buffered(write_stream),
            ManageSellOfferResult::ManageSellOfferBuyNoTrust => ManageSellOfferResultCode::ManageSellOfferBuyNoTrust.to_xdr_buffered(write_stream),
            ManageSellOfferResult::ManageSellOfferSellNotAuthorized => ManageSellOfferResultCode::ManageSellOfferSellNotAuthorized.to_xdr_buffered(write_stream),
            ManageSellOfferResult::ManageSellOfferBuyNotAuthorized => ManageSellOfferResultCode::ManageSellOfferBuyNotAuthorized.to_xdr_buffered(write_stream),
            ManageSellOfferResult::ManageSellOfferLineFull => ManageSellOfferResultCode::ManageSellOfferLineFull.to_xdr_buffered(write_stream),
            ManageSellOfferResult::ManageSellOfferUnderfunded => ManageSellOfferResultCode::ManageSellOfferUnderfunded.to_xdr_buffered(write_stream),
            ManageSellOfferResult::ManageSellOfferCrossSelf => ManageSellOfferResultCode::ManageSellOfferCrossSelf.to_xdr_buffered(write_stream),
            ManageSellOfferResult::ManageSellOfferSellNoIssuer => ManageSellOfferResultCode::ManageSellOfferSellNoIssuer.to_xdr_buffered(write_stream),
            ManageSellOfferResult::ManageSellOfferBuyNoIssuer => ManageSellOfferResultCode::ManageSellOfferBuyNoIssuer.to_xdr_buffered(write_stream),
            ManageSellOfferResult::ManageSellOfferNotFound => ManageSellOfferResultCode::ManageSellOfferNotFound.to_xdr_buffered(write_stream),
            ManageSellOfferResult::ManageSellOfferLowReserve => ManageSellOfferResultCode::ManageSellOfferLowReserve.to_xdr_buffered(write_stream),
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match ManageSellOfferResultCode::from_xdr_buffered(read_stream)? {
            ManageSellOfferResultCode::ManageSellOfferSuccess => Ok(ManageSellOfferResult::ManageSellOfferSuccess(ManageOfferSuccessResult::from_xdr_buffered(read_stream)?)),
            ManageSellOfferResultCode::ManageSellOfferMalformed => Ok(ManageSellOfferResult::ManageSellOfferMalformed),
            ManageSellOfferResultCode::ManageSellOfferSellNoTrust => Ok(ManageSellOfferResult::ManageSellOfferSellNoTrust),
            ManageSellOfferResultCode::ManageSellOfferBuyNoTrust => Ok(ManageSellOfferResult::ManageSellOfferBuyNoTrust),
            ManageSellOfferResultCode::ManageSellOfferSellNotAuthorized => Ok(ManageSellOfferResult::ManageSellOfferSellNotAuthorized),
            ManageSellOfferResultCode::ManageSellOfferBuyNotAuthorized => Ok(ManageSellOfferResult::ManageSellOfferBuyNotAuthorized),
            ManageSellOfferResultCode::ManageSellOfferLineFull => Ok(ManageSellOfferResult::ManageSellOfferLineFull),
            ManageSellOfferResultCode::ManageSellOfferUnderfunded => Ok(ManageSellOfferResult::ManageSellOfferUnderfunded),
            ManageSellOfferResultCode::ManageSellOfferCrossSelf => Ok(ManageSellOfferResult::ManageSellOfferCrossSelf),
            ManageSellOfferResultCode::ManageSellOfferSellNoIssuer => Ok(ManageSellOfferResult::ManageSellOfferSellNoIssuer),
            ManageSellOfferResultCode::ManageSellOfferBuyNoIssuer => Ok(ManageSellOfferResult::ManageSellOfferBuyNoIssuer),
            ManageSellOfferResultCode::ManageSellOfferNotFound => Ok(ManageSellOfferResult::ManageSellOfferNotFound),
            ManageSellOfferResultCode::ManageSellOfferLowReserve => Ok(ManageSellOfferResult::ManageSellOfferLowReserve),
        }
    }
}
...
impl XdrCodec for ManageBuyOfferResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ManageBuyOfferResult::ManageBuyOfferSuccess(value) => {ManageBuyOfferResultCode::ManageBuyOfferSuccess.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ManageBuyOfferResult::ManageBuyOfferMalformed => ManageBuyOfferResultCode::ManageBuyOfferMalformed.to_xdr_buffered(write_stream),
            ManageBuyOfferResult::ManageBuyOfferSellNoTrust => ManageBuyOfferResultCode::ManageBuyOfferSellNoTrust.to_xdr_buffered(write_stream),
            ManageBuyOfferResult::ManageBuyOfferBuyNoTrust => ManageBuyOfferResultCode::ManageBuyOfferBuyNoTrust.to_xdr_buffered(write_stream),
            ManageBuyOfferResult::ManageBuyOfferSellNotAuthorized => ManageBuyOfferResultCode::ManageBuyOfferSellNotAuthorized.to_xdr_buffered(write_stream),
            ManageBuyOfferResult::ManageBuyOfferBuyNotAuthorized => ManageBuyOfferResultCode::ManageBuyOfferBuyNotAuthorized.to_xdr_buffered(write_stream),
            ManageBuyOfferResult::ManageBuyOfferLineFull => ManageBuyOfferResultCode::ManageBuyOfferLineFull.to_xdr_buffered(write_stream),
            ManageBuyOfferResult::ManageBuyOfferUnderfunded => ManageBuyOfferResultCode::ManageBuyOfferUnderfunded.to_xdr_buffered(write_stream),
            ManageBuyOfferResult::ManageBuyOfferCrossSelf => ManageBuyOfferResultCode::ManageBuyOfferCrossSelf.to_xdr_buffered(write_stream),
            ManageBuyOfferResult::ManageBuyOfferSellNoIssuer => ManageBuyOfferResultCode::ManageBuyOfferSellNoIssuer.to_xdr_buffered(write_stream),
            ManageBuyOfferResult::ManageBuyOfferBuyNoIssuer => ManageBuyOfferResultCode::ManageBuyOfferBuyNoIssuer.to_xdr_buffered(write_stream),
            ManageBuyOfferResult::ManageBuyOfferNotFound => ManageBuyOfferResultCode::ManageBuyOfferNotFound.to_xdr_buffered(write_stream),
            ManageBuyOfferResult::ManageBuyOfferLowReserve => ManageBuyOfferResultCode::ManageBuyOfferLowReserve.to_xdr_buffered(write_stream),
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match ManageBuyOfferResultCode::from_xdr_buffered(read_stream)? {
            ManageBuyOfferResultCode::ManageBuyOfferSuccess => Ok(ManageBuyOfferResult::ManageBuyOfferSuccess(ManageOfferSuccessResult::from_xdr_buffered(read_stream)?)),
            ...
            ManageBuyOfferResultCode::ManageBuyOfferSellNotAuthorized => Ok(ManageBuyOfferResult::ManageBuyOfferSellNotAuthorized),
            ManageBuyOfferResultCode::ManageBuyOfferBuyNotAuthorized => Ok(ManageBuyOfferResult::ManageBuyOfferBuyNotAuthorized),
            ...
            ManageBuyOfferResultCode::ManageBuyOfferSellNoIssuer => Ok(ManageBuyOfferResult::ManageBuyOfferSellNoIssuer),
...
impl XdrCodec for SetOptionsResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            SetOptionsResult::SetOptionsSuccess => SetOptionsResultCode::SetOptionsSuccess.to_xdr_buffered(write_stream),
            SetOptionsResult::SetOptionsLowReserve => SetOptionsResultCode::SetOptionsLowReserve.to_xdr_buffered(write_stream),
            SetOptionsResult::SetOptionsTooManySigners => SetOptionsResultCode::SetOptionsTooManySigners.to_xdr_buffered(write_stream),
            SetOptionsResult::SetOptionsBadFlags => SetOptionsResultCode::SetOptionsBadFlags.to_xdr_buffered(write_stream),
            SetOptionsResult::SetOptionsInvalidInflation => SetOptionsResultCode::SetOptionsInvalidInflation.to_xdr_buffered(write_stream),
            SetOptionsResult::SetOptionsCantChange => SetOptionsResultCode::SetOptionsCantChange.to_xdr_buffered(write_stream),
            SetOptionsResult::SetOptionsUnknownFlag => SetOptionsResultCode::SetOptionsUnknownFlag.to_xdr_buffered(write_stream),
            SetOptionsResult::SetOptionsThresholdOutOfRange => SetOptionsResultCode::SetOptionsThresholdOutOfRange.to_xdr_buffered(write_stream),
            SetOptionsResult::SetOptionsBadSigner => SetOptionsResultCode::SetOptionsBadSigner.to_xdr_buffered(write_stream),
            SetOptionsResult::SetOptionsInvalidHomeDomain => SetOptionsResultCode::SetOptionsInvalidHomeDomain.to_xdr_buffered(write_stream),
            SetOptionsResult::SetOptionsAuthRevocableRequired => SetOptionsResultCode::SetOptionsAuthRevocableRequired.to_xdr_buffered(write_stream),
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match SetOptionsResultCode::from_xdr_buffered(read_stream)? {
            ...
            SetOptionsResultCode::SetOptionsAuthRevocableRequired => Ok(SetOptionsResult::SetOptionsAuthRevocableRequired),
        }
    }
}
...
impl XdrCodec for ChangeTrustResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ChangeTrustResult::ChangeTrustSuccess => ChangeTrustResultCode::ChangeTrustSuccess.to_xdr_buffered(write_stream),
            ChangeTrustResult::ChangeTrustMalformed => ChangeTrustResultCode::ChangeTrustMalformed.to_xdr_buffered(write_stream),
            ChangeTrustResult::ChangeTrustNoIssuer => ChangeTrustResultCode::ChangeTrustNoIssuer.to_xdr_buffered(write_stream),
            ChangeTrustResult::ChangeTrustInvalidLimit => ChangeTrustResultCode::ChangeTrustInvalidLimit.to_xdr_buffered(write_stream),
            ChangeTrustResult::ChangeTrustLowReserve => ChangeTrustResultCode::ChangeTrustLowReserve.to_xdr_buffered(write_stream),
            ChangeTrustResult::ChangeTrustSelfNotAllowed => ChangeTrustResultCode::ChangeTrustSelfNotAllowed.to_xdr_buffered(write_stream),
            ChangeTrustResult::ChangeTrustTrustLineMissing => ChangeTrustResultCode::ChangeTrustTrustLineMissing.to_xdr_buffered(write_stream),
            ChangeTrustResult::ChangeTrustCannotDelete => ChangeTrustResultCode::ChangeTrustCannotDelete.to_xdr_buffered(write_stream),
            ChangeTrustResult::ChangeTrustNotAuthMaintainLiabilities => ChangeTrustResultCode::ChangeTrustNotAuthMaintainLiabilities.to_xdr_buffered(write_stream),
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match ChangeTrustResultCode::from_xdr_buffered(read_stream)? {
            ...
            ChangeTrustResultCode::ChangeTrustNotAuthMaintainLiabilities => Ok(ChangeTrustResult::ChangeTrustNotAuthMaintainLiabilities),
        }
    }
}
...
impl XdrCodec for AllowTrustResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            AllowTrustResult::AllowTrustSuccess => AllowTrustResultCode::AllowTrustSuccess.to_xdr_buffered(write_stream),
            AllowTrustResult::AllowTrustMalformed => AllowTrustResultCode::AllowTrustMalformed.to_xdr_buffered(write_stream),
            AllowTrustResult::AllowTrustNoTrustLine => AllowTrustResultCode::AllowTrustNoTrustLine.to_xdr_buffered(write_stream),
            AllowTrustResult::AllowTrustTrustNotRequired => AllowTrustResultCode::AllowTrustTrustNotRequired.to_xdr_buffered(write_stream),
            AllowTrustResult::AllowTrustCantRevoke => AllowTrustResultCode::AllowTrustCantRevoke.to_xdr_buffered(write_stream),
            AllowTrustResult::AllowTrustSelfNotAllowed => AllowTrustResultCode::AllowTrustSelfNotAllowed.to_xdr_buffered(write_stream),
            AllowTrustResult::AllowTrustLowReserve => AllowTrustResultCode::AllowTrustLowReserve.to_xdr_buffered(write_stream),
        }
    }
...
impl XdrCodec for AccountMergeResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            AccountMergeResult::AccountMergeSuccess(value) => {AccountMergeResultCode::AccountMergeSuccess.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            AccountMergeResult::AccountMergeMalformed => AccountMergeResultCode::AccountMergeMalformed.to_xdr_buffered(write_stream),
            AccountMergeResult::AccountMergeNoAccount => AccountMergeResultCode::AccountMergeNoAccount.to_xdr_buffered(write_stream),
            AccountMergeResult::AccountMergeImmutableSet => AccountMergeResultCode::AccountMergeImmutableSet.to_xdr_buffered(write_stream),
            AccountMergeResult::AccountMergeHasSubEntries => AccountMergeResultCode::AccountMergeHasSubEntries.to_xdr_buffered(write_stream),
            AccountMergeResult::AccountMergeSeqnumTooFar => AccountMergeResultCode::AccountMergeSeqnumTooFar.to_xdr_buffered(write_stream),
            AccountMergeResult::AccountMergeDestFull => AccountMergeResultCode::AccountMergeDestFull.to_xdr_buffered(write_stream),
            AccountMergeResult::AccountMergeIsSponsor => AccountMergeResultCode::AccountMergeIsSponsor.to_xdr_buffered(write_stream),
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match AccountMergeResultCode::from_xdr_buffered(read_stream)? {
            AccountMergeResultCode::AccountMergeSuccess => Ok(AccountMergeResult::AccountMergeSuccess(Int64::from_xdr_buffered(read_stream)?)),
...
impl XdrCodec for InflationResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            InflationResult::InflationSuccess(value) => {InflationResultCode::InflationSuccess.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match InflationResultCode::from_xdr_buffered(read_stream)? {
            InflationResultCode::InflationSuccess => Ok(InflationResult::InflationSuccess(UnlimitedVarArray::<InflationPayout>::from_xdr_buffered(read_stream)?)),
...
impl XdrCodec for ManageDataResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ManageDataResult::ManageDataSuccess => ManageDataResultCode::ManageDataSuccess.to_xdr_buffered(write_stream),
            ManageDataResult::ManageDataNotSupportedYet => ManageDataResultCode::ManageDataNotSupportedYet.to_xdr_buffered(write_stream),
            ManageDataResult::ManageDataNameNotFound => ManageDataResultCode::ManageDataNameNotFound.to_xdr_buffered(write_stream),
            ManageDataResult::ManageDataLowReserve => ManageDataResultCode::ManageDataLowReserve.to_xdr_buffered(write_stream),
            ManageDataResult::ManageDataInvalidName => ManageDataResultCode::ManageDataInvalidName.to_xdr_buffered(write_stream),
        }
    }
...
impl XdrCodec for BumpSequenceResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            BumpSequenceResult::BumpSequenceSuccess => BumpSequenceResultCode::BumpSequenceSuccess.to_xdr_buffered(write_stream),
            BumpSequenceResult::BumpSequenceBadSeq => BumpSequenceResultCode::BumpSequenceBadSeq.to_xdr_buffered(write_stream),
        }
    }
...
impl XdrCodec for CreateClaimableBalanceResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            CreateClaimableBalanceResult::CreateClaimableBalanceSuccess(value) => {CreateClaimableBalanceResultCode::CreateClaimableBalanceSuccess.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            CreateClaimableBalanceResult::CreateClaimableBalanceMalformed => CreateClaimableBalanceResultCode::CreateClaimableBalanceMalformed.to_xdr_buffered(write_stream),
            CreateClaimableBalanceResult::CreateClaimableBalanceLowReserve => CreateClaimableBalanceResultCode::CreateClaimableBalanceLowReserve.to_xdr_buffered(write_stream),
            CreateClaimableBalanceResult::CreateClaimableBalanceNoTrust => CreateClaimableBalanceResultCode::CreateClaimableBalanceNoTrust.to_xdr_buffered(write_stream),
            CreateClaimableBalanceResult::CreateClaimableBalanceNotAuthorized => CreateClaimableBalanceResultCode::CreateClaimableBalanceNotAuthorized.to_xdr_buffered(write_stream),
            CreateClaimableBalanceResult::CreateClaimableBalanceUnderfunded => CreateClaimableBalanceResultCode::CreateClaimableBalanceUnderfunded.to_xdr_buffered(write_stream),
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match CreateClaimableBalanceResultCode::from_xdr_buffered(read_stream)? {
            CreateClaimableBalanceResultCode::CreateClaimableBalanceSuccess => Ok(CreateClaimableBalanceResult::CreateClaimableBalanceSuccess(ClaimableBalanceId::from_xdr_buffered(read_stream)?)),
            CreateClaimableBalanceResultCode::CreateClaimableBalanceMalformed => Ok(CreateClaimableBalanceResult::CreateClaimableBalanceMalformed),
            CreateClaimableBalanceResultCode::CreateClaimableBalanceLowReserve => Ok(CreateClaimableBalanceResult::CreateClaimableBalanceLowReserve),
            CreateClaimableBalanceResultCode::CreateClaimableBalanceNoTrust => Ok(CreateClaimableBalanceResult::CreateClaimableBalanceNoTrust),
            CreateClaimableBalanceResultCode::CreateClaimableBalanceNotAuthorized => Ok(CreateClaimableBalanceResult::CreateClaimableBalanceNotAuthorized),
            CreateClaimableBalanceResultCode::CreateClaimableBalanceUnderfunded => Ok(CreateClaimableBalanceResult::CreateClaimableBalanceUnderfunded),
        }
    }
}
...
impl XdrCodec for ClaimClaimableBalanceResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ClaimClaimableBalanceResult::ClaimClaimableBalanceSuccess => ClaimClaimableBalanceResultCode::ClaimClaimableBalanceSuccess.to_xdr_buffered(write_stream),
            ClaimClaimableBalanceResult::ClaimClaimableBalanceDoesNotExist => ClaimClaimableBalanceResultCode::ClaimClaimableBalanceDoesNotExist.to_xdr_buffered(write_stream),
            ClaimClaimableBalanceResult::ClaimClaimableBalanceCannotClaim => ClaimClaimableBalanceResultCode::ClaimClaimableBalanceCannotClaim.to_xdr_buffered(write_stream),
            ClaimClaimableBalanceResult::ClaimClaimableBalanceLineFull => ClaimClaimableBalanceResultCode::ClaimClaimableBalanceLineFull.to_xdr_buffered(write_stream),
            ClaimClaimableBalanceResult::ClaimClaimableBalanceNoTrust => ClaimClaimableBalanceResultCode::ClaimClaimableBalanceNoTrust.to_xdr_buffered(write_stream),
            ClaimClaimableBalanceResult::ClaimClaimableBalanceNotAuthorized => ClaimClaimableBalanceResultCode::ClaimClaimableBalanceNotAuthorized.to_xdr_buffered(write_stream),
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match ClaimClaimableBalanceResultCode::from_xdr_buffered(read_stream)? {
            ClaimClaimableBalanceResultCode::ClaimClaimableBalanceSuccess => Ok(ClaimClaimableBalanceResult::ClaimClaimableBalanceSuccess),
            ClaimClaimableBalanceResultCode::ClaimClaimableBalanceDoesNotExist => Ok(ClaimClaimableBalanceResult::ClaimClaimableBalanceDoesNotExist),
            ClaimClaimableBalanceResultCode::ClaimClaimableBalanceCannotClaim => Ok(ClaimClaimableBalanceResult::ClaimClaimableBalanceCannotClaim),
            ClaimClaimableBalanceResultCode::ClaimClaimableBalanceLineFull => Ok(ClaimClaimableBalanceResult::ClaimClaimableBalanceLineFull),
            ClaimClaimableBalanceResultCode::ClaimClaimableBalanceNoTrust => Ok(ClaimClaimableBalanceResult::ClaimClaimableBalanceNoTrust),
            ClaimClaimableBalanceResultCode::ClaimClaimableBalanceNotAuthorized => Ok(ClaimClaimableBalanceResult::ClaimClaimableBalanceNotAuthorized),
        }
    }
}
...
impl XdrCodec for BeginSponsoringFutureReservesResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            BeginSponsoringFutureReservesResult::BeginSponsoringFutureReservesSuccess => BeginSponsoringFutureReservesResultCode::BeginSponsoringFutureReservesSuccess.to_xdr_buffered(write_stream),
            BeginSponsoringFutureReservesResult::BeginSponsoringFutureReservesMalformed => BeginSponsoringFutureReservesResultCode::BeginSponsoringFutureReservesMalformed.to_xdr_buffered(write_stream),
            BeginSponsoringFutureReservesResult::BeginSponsoringFutureReservesAlreadySponsored => BeginSponsoringFutureReservesResultCode::BeginSponsoringFutureReservesAlreadySponsored.to_xdr_buffered(write_stream),
            BeginSponsoringFutureReservesResult::BeginSponsoringFutureReservesRecursive => BeginSponsoringFutureReservesResultCode::BeginSponsoringFutureReservesRecursive.to_xdr_buffered(write_stream),
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match BeginSponsoringFutureReservesResultCode::from_xdr_buffered(read_stream)? {
            BeginSponsoringFutureReservesResultCode::BeginSponsoringFutureReservesSuccess => Ok(BeginSponsoringFutureReservesResult::BeginSponsoringFutureReservesSuccess),
            BeginSponsoringFutureReservesResultCode::BeginSponsoringFutureReservesMalformed => Ok(BeginSponsoringFutureReservesResult::BeginSponsoringFutureReservesMalformed),
            BeginSponsoringFutureReservesResultCode::BeginSponsoringFutureReservesAlreadySponsored => Ok(BeginSponsoringFutureReservesResult::BeginSponsoringFutureReservesAlreadySponsored),
            BeginSponsoringFutureReservesResultCode::BeginSponsoringFutureReservesRecursive => Ok(BeginSponsoringFutureReservesResult::BeginSponsoringFutureReservesRecursive),
        }
    }
}
...
impl XdrCodec for EndSponsoringFutureReservesResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            EndSponsoringFutureReservesResult::EndSponsoringFutureReservesSuccess => EndSponsoringFutureReservesResultCode::EndSponsoringFutureReservesSuccess.to_xdr_buffered(write_stream),
            EndSponsoringFutureReservesResult::EndSponsoringFutureReservesNotSponsored => EndSponsoringFutureReservesResultCode::EndSponsoringFutureReservesNotSponsored.to_xdr_buffered(write_stream),
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match EndSponsoringFutureReservesResultCode::from_xdr_buffered(read_stream)? {
            EndSponsoringFutureReservesResultCode::EndSponsoringFutureReservesSuccess => Ok(EndSponsoringFutureReservesResult::EndSponsoringFutureReservesSuccess),
            EndSponsoringFutureReservesResultCode::EndSponsoringFutureReservesNotSponsored => Ok(EndSponsoringFutureReservesResult::EndSponsoringFutureReservesNotSponsored),
        }
    }
}
...
impl XdrCodec for RevokeSponsorshipResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            RevokeSponsorshipResult::RevokeSponsorshipSuccess => RevokeSponsorshipResultCode::RevokeSponsorshipSuccess.to_xdr_buffered(write_stream),
            RevokeSponsorshipResult::RevokeSponsorshipDoesNotExist => RevokeSponsorshipResultCode::RevokeSponsorshipDoesNotExist.to_xdr_buffered(write_stream),
            RevokeSponsorshipResult::RevokeSponsorshipNotSponsor => RevokeSponsorshipResultCode::RevokeSponsorshipNotSponsor.to_xdr_buffered(write_stream),
            RevokeSponsorshipResult::RevokeSponsorshipLowReserve => RevokeSponsorshipResultCode::RevokeSponsorshipLowReserve.to_xdr_buffered(write_stream),
            RevokeSponsorshipResult::RevokeSponsorshipOnlyTransferable => RevokeSponsorshipResultCode::RevokeSponsorshipOnlyTransferable.to_xdr_buffered(write_stream),
            RevokeSponsorshipResult::RevokeSponsorshipMalformed => RevokeSponsorshipResultCode::RevokeSponsorshipMalformed.to_xdr_buffered(write_stream),
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match RevokeSponsorshipResultCode::from_xdr_buffered(read_stream)? {
            RevokeSponsorshipResultCode::RevokeSponsorshipSuccess => Ok(RevokeSponsorshipResult::RevokeSponsorshipSuccess),
            RevokeSponsorshipResultCode::RevokeSponsorshipDoesNotExist => Ok(RevokeSponsorshipResult::RevokeSponsorshipDoesNotExist),
            RevokeSponsorshipResultCode::RevokeSponsorshipNotSponsor => Ok(RevokeSponsorshipResult::RevokeSponsorshipNotSponsor),
            RevokeSponsorshipResultCode::RevokeSponsorshipLowReserve => Ok(RevokeSponsorshipResult::RevokeSponsorshipLowReserve),
            RevokeSponsorshipResultCode::RevokeSponsorshipOnlyTransferable => Ok(RevokeSponsorshipResult::RevokeSponsorshipOnlyTransferable),
            RevokeSponsorshipResultCode::RevokeSponsorshipMalformed => Ok(RevokeSponsorshipResult::RevokeSponsorshipMalformed),
        }
    }
}
...
impl XdrCodec for ClawbackResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ...
            ClawbackResult::ClawbackNotClawbackEnabled => ClawbackResultCode::ClawbackNotClawbackEnabled.to_xdr_buffered(write_stream),
            ClawbackResult::ClawbackNoTrust => ClawbackResultCode::ClawbackNoTrust.to_xdr_buffered(write_stream),
            ClawbackResult::ClawbackUnderfunded => ClawbackResultCode::ClawbackUnderfunded.to_xdr_buffered(write_stream),
        }
    }
...
impl XdrCodec for ClawbackClaimableBalanceResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ClawbackClaimableBalanceResult::ClawbackClaimableBalanceSuccess => ClawbackClaimableBalanceResultCode::ClawbackClaimableBalanceSuccess.to_xdr_buffered(write_stream),
            ClawbackClaimableBalanceResult::ClawbackClaimableBalanceDoesNotExist => ClawbackClaimableBalanceResultCode::ClawbackClaimableBalanceDoesNotExist.to_xdr_buffered(write_stream),
            ClawbackClaimableBalanceResult::ClawbackClaimableBalanceNotIssuer => ClawbackClaimableBalanceResultCode::ClawbackClaimableBalanceNotIssuer.to_xdr_buffered(write_stream),
            ClawbackClaimableBalanceResult::ClawbackClaimableBalanceNotClawbackEnabled => ClawbackClaimableBalanceResultCode::ClawbackClaimableBalanceNotClawbackEnabled.to_xdr_buffered(write_stream),
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match ClawbackClaimableBalanceResultCode::from_xdr_buffered(read_stream)? {
            ClawbackClaimableBalanceResultCode::ClawbackClaimableBalanceSuccess => Ok(ClawbackClaimableBalanceResult::ClawbackClaimableBalanceSuccess),
            ClawbackClaimableBalanceResultCode::ClawbackClaimableBalanceDoesNotExist => Ok(ClawbackClaimableBalanceResult::ClawbackClaimableBalanceDoesNotExist),
            ClawbackClaimableBalanceResultCode::ClawbackClaimableBalanceNotIssuer => Ok(ClawbackClaimableBalanceResult::ClawbackClaimableBalanceNotIssuer),
            ClawbackClaimableBalanceResultCode::ClawbackClaimableBalanceNotClawbackEnabled => Ok(ClawbackClaimableBalanceResult::ClawbackClaimableBalanceNotClawbackEnabled),
        }
    }
}
...
impl XdrCodec for SetTrustLineFlagsResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            SetTrustLineFlagsResult::SetTrustLineFlagsSuccess => SetTrustLineFlagsResultCode::SetTrustLineFlagsSuccess.to_xdr_buffered(write_stream),
            SetTrustLineFlagsResult::SetTrustLineFlagsMalformed => SetTrustLineFlagsResultCode::SetTrustLineFlagsMalformed.to_xdr_buffered(write_stream),
            SetTrustLineFlagsResult::SetTrustLineFlagsNoTrustLine => SetTrustLineFlagsResultCode::SetTrustLineFlagsNoTrustLine.to_xdr_buffered(write_stream),
            SetTrustLineFlagsResult::SetTrustLineFlagsCantRevoke => SetTrustLineFlagsResultCode::SetTrustLineFlagsCantRevoke.to_xdr_buffered(write_stream),
            SetTrustLineFlagsResult::SetTrustLineFlagsInvalidState => SetTrustLineFlagsResultCode::SetTrustLineFlagsInvalidState.to_xdr_buffered(write_stream),
            SetTrustLineFlagsResult::SetTrustLineFlagsLowReserve => SetTrustLineFlagsResultCode::SetTrustLineFlagsLowReserve.to_xdr_buffered(write_stream),
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match SetTrustLineFlagsResultCode::from_xdr_buffered(read_stream)? {
            SetTrustLineFlagsResultCode::SetTrustLineFlagsSuccess => Ok(SetTrustLineFlagsResult::SetTrustLineFlagsSuccess),
            SetTrustLineFlagsResultCode::SetTrustLineFlagsMalformed => Ok(SetTrustLineFlagsResult::SetTrustLineFlagsMalformed),
            SetTrustLineFlagsResultCode::SetTrustLineFlagsNoTrustLine => Ok(SetTrustLineFlagsResult::SetTrustLineFlagsNoTrustLine),
            SetTrustLineFlagsResultCode::SetTrustLineFlagsCantRevoke => Ok(SetTrustLineFlagsResult::SetTrustLineFlagsCantRevoke),
            SetTrustLineFlagsResultCode::SetTrustLineFlagsInvalidState => Ok(SetTrustLineFlagsResult::SetTrustLineFlagsInvalidState),
            SetTrustLineFlagsResultCode::SetTrustLineFlagsLowReserve => Ok(SetTrustLineFlagsResult::SetTrustLineFlagsLowReserve),
        }
    }
}
...
impl XdrCodec for LiquidityPoolDepositResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            LiquidityPoolDepositResult::LiquidityPoolDepositSuccess => LiquidityPoolDepositResultCode::LiquidityPoolDepositSuccess.to_xdr_buffered(write_stream),
            LiquidityPoolDepositResult::LiquidityPoolDepositMalformed => LiquidityPoolDepositResultCode::LiquidityPoolDepositMalformed.to_xdr_buffered(write_stream),
            LiquidityPoolDepositResult::LiquidityPoolDepositNoTrust => LiquidityPoolDepositResultCode::LiquidityPoolDepositNoTrust.to_xdr_buffered(write_stream),
            LiquidityPoolDepositResult::LiquidityPoolDepositNotAuthorized => LiquidityPoolDepositResultCode::LiquidityPoolDepositNotAuthorized.to_xdr_buffered(write_stream),
            LiquidityPoolDepositResult::LiquidityPoolDepositUnderfunded => LiquidityPoolDepositResultCode::LiquidityPoolDepositUnderfunded.to_xdr_buffered(write_stream),
            LiquidityPoolDepositResult::LiquidityPoolDepositLineFull => LiquidityPoolDepositResultCode::LiquidityPoolDepositLineFull.to_xdr_buffered(write_stream),
            LiquidityPoolDepositResult::LiquidityPoolDepositBadPrice => LiquidityPoolDepositResultCode::LiquidityPoolDepositBadPrice.to_xdr_buffered(write_stream),
            LiquidityPoolDepositResult::LiquidityPoolDepositPoolFull => LiquidityPoolDepositResultCode::LiquidityPoolDepositPoolFull.to_xdr_buffered(write_stream),
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match LiquidityPoolDepositResultCode::from_xdr_buffered(read_stream)? {
            LiquidityPoolDepositResultCode::LiquidityPoolDepositSuccess => Ok(LiquidityPoolDepositResult::LiquidityPoolDepositSuccess),
            LiquidityPoolDepositResultCode::LiquidityPoolDepositMalformed => Ok(LiquidityPoolDepositResult::LiquidityPoolDepositMalformed),
            LiquidityPoolDepositResultCode::LiquidityPoolDepositNoTrust => Ok(LiquidityPoolDepositResult::LiquidityPoolDepositNoTrust),
            LiquidityPoolDepositResultCode::LiquidityPoolDepositNotAuthorized => Ok(LiquidityPoolDepositResult::LiquidityPoolDepositNotAuthorized),
            LiquidityPoolDepositResultCode::LiquidityPoolDepositUnderfunded => Ok(LiquidityPoolDepositResult::LiquidityPoolDepositUnderfunded),
            LiquidityPoolDepositResultCode::LiquidityPoolDepositLineFull => Ok(LiquidityPoolDepositResult::LiquidityPoolDepositLineFull),
            LiquidityPoolDepositResultCode::LiquidityPoolDepositBadPrice => Ok(LiquidityPoolDepositResult::LiquidityPoolDepositBadPrice),
            LiquidityPoolDepositResultCode::LiquidityPoolDepositPoolFull => Ok(LiquidityPoolDepositResult::LiquidityPoolDepositPoolFull),
        }
    }
}
...
impl XdrCodec for LiquidityPoolWithdrawResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            LiquidityPoolWithdrawResult::LiquidityPoolWithdrawSuccess => LiquidityPoolWithdrawResultCode::LiquidityPoolWithdrawSuccess.to_xdr_buffered(write_stream),
            LiquidityPoolWithdrawResult::LiquidityPoolWithdrawMalformed => LiquidityPoolWithdrawResultCode::LiquidityPoolWithdrawMalformed.to_xdr_buffered(write_stream),
            LiquidityPoolWithdrawResult::LiquidityPoolWithdrawNoTrust => LiquidityPoolWithdrawResultCode::LiquidityPoolWithdrawNoTrust.to_xdr_buffered(write_stream),
            LiquidityPoolWithdrawResult::LiquidityPoolWithdrawUnderfunded => LiquidityPoolWithdrawResultCode::LiquidityPoolWithdrawUnderfunded.to_xdr_buffered(write_stream),
            LiquidityPoolWithdrawResult::LiquidityPoolWithdrawLineFull => LiquidityPoolWithdrawResultCode::LiquidityPoolWithdrawLineFull.to_xdr_buffered(write_stream),
            LiquidityPoolWithdrawResult::LiquidityPoolWithdrawUnderMinimum => LiquidityPoolWithdrawResultCode::LiquidityPoolWithdrawUnderMinimum.to_xdr_buffered(write_stream),
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match LiquidityPoolWithdrawResultCode::from_xdr_buffered(read_stream)? {
            LiquidityPoolWithdrawResultCode::LiquidityPoolWithdrawSuccess => Ok(LiquidityPoolWithdrawResult::LiquidityPoolWithdrawSuccess),
            LiquidityPoolWithdrawResultCode::LiquidityPoolWithdrawMalformed => Ok(LiquidityPoolWithdrawResult::LiquidityPoolWithdrawMalformed),
            LiquidityPoolWithdrawResultCode::LiquidityPoolWithdrawNoTrust => Ok(LiquidityPoolWithdrawResult::LiquidityPoolWithdrawNoTrust),
            LiquidityPoolWithdrawResultCode::LiquidityPoolWithdrawUnderfunded => Ok(LiquidityPoolWithdrawResult::LiquidityPoolWithdrawUnderfunded),
            LiquidityPoolWithdrawResultCode::LiquidityPoolWithdrawLineFull => Ok(LiquidityPoolWithdrawResult::LiquidityPoolWithdrawLineFull),
            LiquidityPoolWithdrawResultCode::LiquidityPoolWithdrawUnderMinimum => Ok(LiquidityPoolWithdrawResult::LiquidityPoolWithdrawUnderMinimum),
        }
    }
}
...
impl XdrCodec for InvokeHostFunctionResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            InvokeHostFunctionResult::InvokeHostFunctionSuccess(value) => {InvokeHostFunctionResultCode::InvokeHostFunctionSuccess.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            InvokeHostFunctionResult::InvokeHostFunctionMalformed => InvokeHostFunctionResultCode::InvokeHostFunctionMalformed.to_xdr_buffered(write_stream),
            InvokeHostFunctionResult::InvokeHostFunctionTrapped => InvokeHostFunctionResultCode::InvokeHostFunctionTrapped.to_xdr_buffered(write_stream),
            InvokeHostFunctionResult::InvokeHostFunctionResourceLimitExceeded => InvokeHostFunctionResultCode::InvokeHostFunctionResourceLimitExceeded.to_xdr_buffered(write_stream),
            InvokeHostFunctionResult::InvokeHostFunctionEntryExpired => InvokeHostFunctionResultCode::InvokeHostFunctionEntryExpired.to_xdr_buffered(write_stream),
            InvokeHostFunctionResult::InvokeHostFunctionInsufficientRefundableFee => InvokeHostFunctionResultCode::InvokeHostFunctionInsufficientRefundableFee.to_xdr_buffered(write_stream),
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match InvokeHostFunctionResultCode::from_xdr_buffered(read_stream)? {
            InvokeHostFunctionResultCode::InvokeHostFunctionSuccess => Ok(InvokeHostFunctionResult::InvokeHostFunctionSuccess(Hash::from_xdr_buffered(read_stream)?)),
            InvokeHostFunctionResultCode::InvokeHostFunctionMalformed => Ok(InvokeHostFunctionResult::InvokeHostFunctionMalformed),
            InvokeHostFunctionResultCode::InvokeHostFunctionTrapped => Ok(InvokeHostFunctionResult::InvokeHostFunctionTrapped),
            InvokeHostFunctionResultCode::InvokeHostFunctionResourceLimitExceeded => Ok(InvokeHostFunctionResult::InvokeHostFunctionResourceLimitExceeded),
            InvokeHostFunctionResultCode::InvokeHostFunctionEntryExpired => Ok(InvokeHostFunctionResult::InvokeHostFunctionEntryExpired),
            InvokeHostFunctionResultCode::InvokeHostFunctionInsufficientRefundableFee => Ok(InvokeHostFunctionResult::InvokeHostFunctionInsufficientRefundableFee),
        }
    }
}

/// Autogenerated definition for type BumpFootprintExpirationResult
#[allow(dead_code)]
#[derive(Debug, Clone, Eq, PartialEq)]
...
impl XdrCodec for BumpFootprintExpirationResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            BumpFootprintExpirationResult::BumpFootprintExpirationSuccess => BumpFootprintExpirationResultCode::BumpFootprintExpirationSuccess.to_xdr_buffered(write_stream),
            BumpFootprintExpirationResult::BumpFootprintExpirationMalformed => BumpFootprintExpirationResultCode::BumpFootprintExpirationMalformed.to_xdr_buffered(write_stream),
            BumpFootprintExpirationResult::BumpFootprintExpirationResourceLimitExceeded => BumpFootprintExpirationResultCode::BumpFootprintExpirationResourceLimitExceeded.to_xdr_buffered(write_stream),
            BumpFootprintExpirationResult::BumpFootprintExpirationInsufficientRefundableFee => BumpFootprintExpirationResultCode::BumpFootprintExpirationInsufficientRefundableFee.to_xdr_buffered(write_stream),
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match BumpFootprintExpirationResultCode::from_xdr_buffered(read_stream)? {
            BumpFootprintExpirationResultCode::BumpFootprintExpirationSuccess => Ok(BumpFootprintExpirationResult::BumpFootprintExpirationSuccess),
            BumpFootprintExpirationResultCode::BumpFootprintExpirationMalformed => Ok(BumpFootprintExpirationResult::BumpFootprintExpirationMalformed),
            BumpFootprintExpirationResultCode::BumpFootprintExpirationResourceLimitExceeded => Ok(BumpFootprintExpirationResult::BumpFootprintExpirationResourceLimitExceeded),
            BumpFootprintExpirationResultCode::BumpFootprintExpirationInsufficientRefundableFee => Ok(BumpFootprintExpirationResult::BumpFootprintExpirationInsufficientRefundableFee),
        }
    }
}
...
impl XdrCodec for RestoreFootprintResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            RestoreFootprintResult::RestoreFootprintSuccess => RestoreFootprintResultCode::RestoreFootprintSuccess.to_xdr_buffered(write_stream),
            RestoreFootprintResult::RestoreFootprintMalformed => RestoreFootprintResultCode::RestoreFootprintMalformed.to_xdr_buffered(write_stream),
            RestoreFootprintResult::RestoreFootprintResourceLimitExceeded => RestoreFootprintResultCode::RestoreFootprintResourceLimitExceeded.to_xdr_buffered(write_stream),
            RestoreFootprintResult::RestoreFootprintInsufficientRefundableFee => RestoreFootprintResultCode::RestoreFootprintInsufficientRefundableFee.to_xdr_buffered(write_stream),
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match RestoreFootprintResultCode::from_xdr_buffered(read_stream)? {
            ...
            RestoreFootprintResultCode::RestoreFootprintMalformed => Ok(RestoreFootprintResult::RestoreFootprintMalformed),
            RestoreFootprintResultCode::RestoreFootprintResourceLimitExceeded => Ok(RestoreFootprintResult::RestoreFootprintResourceLimitExceeded),
            RestoreFootprintResultCode::RestoreFootprintInsufficientRefundableFee => Ok(RestoreFootprintResult::RestoreFootprintInsufficientRefundableFee),
        }
    }
}
...
impl XdrCodec for OperationResultTr {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            OperationResultTr::CreateAccount(value) => {OperationType::CreateAccount.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationResultTr::Payment(value) => {OperationType::Payment.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationResultTr::PathPaymentStrictReceive(value) => {OperationType::PathPaymentStrictReceive.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationResultTr::ManageSellOffer(value) => {OperationType::ManageSellOffer.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationResultTr::CreatePassiveSellOffer(value) => {OperationType::CreatePassiveSellOffer.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationResultTr::SetOptions(value) => {OperationType::SetOptions.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationResultTr::ChangeTrust(value) => {OperationType::ChangeTrust.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationResultTr::AllowTrust(value) => {OperationType::AllowTrust.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationResultTr::AccountMerge(value) => {OperationType::AccountMerge.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationResultTr::Inflation(value) => {OperationType::Inflation.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationResultTr::ManageData(value) => {OperationType::ManageData.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationResultTr::BumpSequence(value) => {OperationType::BumpSequence.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationResultTr::ManageBuyOffer(value) => {OperationType::ManageBuyOffer.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationResultTr::PathPaymentStrictSend(value) => {OperationType::PathPaymentStrictSend.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationResultTr::CreateClaimableBalance(value) => {OperationType::CreateClaimableBalance.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationResultTr::ClaimClaimableBalance(value) => {OperationType::ClaimClaimableBalance.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationResultTr::BeginSponsoringFutureReserves(value) => {OperationType::BeginSponsoringFutureReserves.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationResultTr::EndSponsoringFutureReserves(value) => {OperationType::EndSponsoringFutureReserves.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationResultTr::RevokeSponsorship(value) => {OperationType::RevokeSponsorship.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationResultTr::Clawback(value) => {OperationType::Clawback.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationResultTr::ClawbackClaimableBalance(value) => {OperationType::ClawbackClaimableBalance.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationResultTr::SetTrustLineFlags(value) => {OperationType::SetTrustLineFlags.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationResultTr::LiquidityPoolDeposit(value) => {OperationType::LiquidityPoolDeposit.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationResultTr::LiquidityPoolWithdraw(value) => {OperationType::LiquidityPoolWithdraw.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationResultTr::InvokeHostFunction(value) => {OperationType::InvokeHostFunction.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationResultTr::BumpFootprintExpiration(value) => {OperationType::BumpFootprintExpiration.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            OperationResultTr::RestoreFootprint(value) => {OperationType::RestoreFootprint.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match OperationType::from_xdr_buffered(read_stream)? {
            OperationType::CreateAccount => Ok(OperationResultTr::CreateAccount(CreateAccountResult::from_xdr_buffered(read_stream)?)),
            OperationType::Payment => Ok(OperationResultTr::Payment(PaymentResult::from_xdr_buffered(read_stream)?)),
            OperationType::PathPaymentStrictReceive => Ok(OperationResultTr::PathPaymentStrictReceive(PathPaymentStrictReceiveResult::from_xdr_buffered(read_stream)?)),
            OperationType::ManageSellOffer => Ok(OperationResultTr::ManageSellOffer(ManageSellOfferResult::from_xdr_buffered(read_stream)?)),
            OperationType::CreatePassiveSellOffer => Ok(OperationResultTr::CreatePassiveSellOffer(ManageSellOfferResult::from_xdr_buffered(read_stream)?)),
            OperationType::SetOptions => Ok(OperationResultTr::SetOptions(SetOptionsResult::from_xdr_buffered(read_stream)?)),
            OperationType::ChangeTrust => Ok(OperationResultTr::ChangeTrust(ChangeTrustResult::from_xdr_buffered(read_stream)?)),
            OperationType::AllowTrust => Ok(OperationResultTr::AllowTrust(AllowTrustResult::from_xdr_buffered(read_stream)?)),
            OperationType::AccountMerge => Ok(OperationResultTr::AccountMerge(AccountMergeResult::from_xdr_buffered(read_stream)?)),
            OperationType::Inflation => Ok(OperationResultTr::Inflation(InflationResult::from_xdr_buffered(read_stream)?)),
            OperationType::ManageData => Ok(OperationResultTr::ManageData(ManageDataResult::from_xdr_buffered(read_stream)?)),
            OperationType::BumpSequence => Ok(OperationResultTr::BumpSequence(BumpSequenceResult::from_xdr_buffered(read_stream)?)),
            OperationType::ManageBuyOffer => Ok(OperationResultTr::ManageBuyOffer(ManageBuyOfferResult::from_xdr_buffered(read_stream)?)),
            OperationType::PathPaymentStrictSend => Ok(OperationResultTr::PathPaymentStrictSend(PathPaymentStrictSendResult::from_xdr_buffered(read_stream)?)),
            OperationType::CreateClaimableBalance => Ok(OperationResultTr::CreateClaimableBalance(CreateClaimableBalanceResult::from_xdr_buffered(read_stream)?)),
            OperationType::ClaimClaimableBalance => Ok(OperationResultTr::ClaimClaimableBalance(ClaimClaimableBalanceResult::from_xdr_buffered(read_stream)?)),
            OperationType::BeginSponsoringFutureReserves => Ok(OperationResultTr::BeginSponsoringFutureReserves(BeginSponsoringFutureReservesResult::from_xdr_buffered(read_stream)?)),
            OperationType::EndSponsoringFutureReserves => Ok(OperationResultTr::EndSponsoringFutureReserves(EndSponsoringFutureReservesResult::from_xdr_buffered(read_stream)?)),
            OperationType::RevokeSponsorship => Ok(OperationResultTr::RevokeSponsorship(RevokeSponsorshipResult::from_xdr_buffered(read_stream)?)),
            OperationType::Clawback => Ok(OperationResultTr::Clawback(ClawbackResult::from_xdr_buffered(read_stream)?)),
            OperationType::ClawbackClaimableBalance => Ok(OperationResultTr::ClawbackClaimableBalance(ClawbackClaimableBalanceResult::from_xdr_buffered(read_stream)?)),
            OperationType::SetTrustLineFlags => Ok(OperationResultTr::SetTrustLineFlags(SetTrustLineFlagsResult::from_xdr_buffered(read_stream)?)),
            OperationType::LiquidityPoolDeposit => Ok(OperationResultTr::LiquidityPoolDeposit(LiquidityPoolDepositResult::from_xdr_buffered(read_stream)?)),
            OperationType::LiquidityPoolWithdraw => Ok(OperationResultTr::LiquidityPoolWithdraw(LiquidityPoolWithdrawResult::from_xdr_buffered(read_stream)?)),
            OperationType::InvokeHostFunction => Ok(OperationResultTr::InvokeHostFunction(InvokeHostFunctionResult::from_xdr_buffered(read_stream)?)),
            ...
            OperationType::RestoreFootprint => Ok(OperationResultTr::RestoreFootprint(RestoreFootprintResult::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for OperationResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            OperationResult::OpInner(value) => {OperationResultCode::OpInner.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ...
            OperationResult::OpTooManySubentries => OperationResultCode::OpTooManySubentries.to_xdr_buffered(write_stream),
            OperationResult::OpExceededWorkLimit => OperationResultCode::OpExceededWorkLimit.to_xdr_buffered(write_stream),
            OperationResult::OpTooManySponsoring => OperationResultCode::OpTooManySponsoring.to_xdr_buffered(write_stream),
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match OperationResultCode::from_xdr_buffered(read_stream)? {
            OperationResultCode::OpInner => Ok(OperationResult::OpInner(OperationResultTr::from_xdr_buffered(read_stream)?)),
...
impl XdrCodec for InnerTransactionResultResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            InnerTransactionResultResult::TxSuccess(value) => {TransactionResultCode::TxSuccess.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            InnerTransactionResultResult::TxFailed(value) => {TransactionResultCode::TxFailed.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ...
            InnerTransactionResultResult::TxMissingOperation => TransactionResultCode::TxMissingOperation.to_xdr_buffered(write_stream),
            ...
            InnerTransactionResultResult::TxInsufficientBalance => TransactionResultCode::TxInsufficientBalance.to_xdr_buffered(write_stream),
            InnerTransactionResultResult::TxNoAccount => TransactionResultCode::TxNoAccount.to_xdr_buffered(write_stream),
            InnerTransactionResultResult::TxInsufficientFee => TransactionResultCode::TxInsufficientFee.to_xdr_buffered(write_stream),
            InnerTransactionResultResult::TxBadAuthExtra => TransactionResultCode::TxBadAuthExtra.to_xdr_buffered(write_stream),
            InnerTransactionResultResult::TxInternalError => TransactionResultCode::TxInternalError.to_xdr_buffered(write_stream),
            InnerTransactionResultResult::TxNotSupported => TransactionResultCode::TxNotSupported.to_xdr_buffered(write_stream),
            InnerTransactionResultResult::TxBadSponsorship => TransactionResultCode::TxBadSponsorship.to_xdr_buffered(write_stream),
            InnerTransactionResultResult::TxBadMinSeqAgeOrGap => TransactionResultCode::TxBadMinSeqAgeOrGap.to_xdr_buffered(write_stream),
            InnerTransactionResultResult::TxMalformed => TransactionResultCode::TxMalformed.to_xdr_buffered(write_stream),
            InnerTransactionResultResult::TxSorobanInvalid => TransactionResultCode::TxSorobanInvalid.to_xdr_buffered(write_stream),
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match TransactionResultCode::from_xdr_buffered(read_stream)? {
            TransactionResultCode::TxSuccess => Ok(InnerTransactionResultResult::TxSuccess(UnlimitedVarArray::<OperationResult>::from_xdr_buffered(read_stream)?)),
            TransactionResultCode::TxFailed => Ok(InnerTransactionResultResult::TxFailed(UnlimitedVarArray::<OperationResult>::from_xdr_buffered(read_stream)?)),
...
impl XdrCodec for TransactionResultResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            TransactionResultResult::TxFeeBumpInnerSuccess(value) => {TransactionResultCode::TxFeeBumpInnerSuccess.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            TransactionResultResult::TxFeeBumpInnerFailed(value) => {TransactionResultCode::TxFeeBumpInnerFailed.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            TransactionResultResult::TxSuccess(value) => {TransactionResultCode::TxSuccess.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            TransactionResultResult::TxFailed(value) => {TransactionResultCode::TxFailed.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            ...
            TransactionResultResult::TxMissingOperation => TransactionResultCode::TxMissingOperation.to_xdr_buffered(write_stream),
            ...
            TransactionResultResult::TxInsufficientBalance => TransactionResultCode::TxInsufficientBalance.to_xdr_buffered(write_stream),
            TransactionResultResult::TxNoAccount => TransactionResultCode::TxNoAccount.to_xdr_buffered(write_stream),
            TransactionResultResult::TxInsufficientFee => TransactionResultCode::TxInsufficientFee.to_xdr_buffered(write_stream),
            TransactionResultResult::TxBadAuthExtra => TransactionResultCode::TxBadAuthExtra.to_xdr_buffered(write_stream),
            TransactionResultResult::TxInternalError => TransactionResultCode::TxInternalError.to_xdr_buffered(write_stream),
            TransactionResultResult::TxNotSupported => TransactionResultCode::TxNotSupported.to_xdr_buffered(write_stream),
            TransactionResultResult::TxBadSponsorship => TransactionResultCode::TxBadSponsorship.to_xdr_buffered(write_stream),
            TransactionResultResult::TxBadMinSeqAgeOrGap => TransactionResultCode::TxBadMinSeqAgeOrGap.to_xdr_buffered(write_stream),
            TransactionResultResult::TxMalformed => TransactionResultCode::TxMalformed.to_xdr_buffered(write_stream),
            TransactionResultResult::TxSorobanInvalid => TransactionResultCode::TxSorobanInvalid.to_xdr_buffered(write_stream),
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match TransactionResultCode::from_xdr_buffered(read_stream)? {
            TransactionResultCode::TxFeeBumpInnerSuccess => Ok(TransactionResultResult::TxFeeBumpInnerSuccess(InnerTransactionResultPair::from_xdr_buffered(read_stream)?)),
            TransactionResultCode::TxFeeBumpInnerFailed => Ok(TransactionResultResult::TxFeeBumpInnerFailed(InnerTransactionResultPair::from_xdr_buffered(read_stream)?)),
            TransactionResultCode::TxSuccess => Ok(TransactionResultResult::TxSuccess(UnlimitedVarArray::<OperationResult>::from_xdr_buffered(read_stream)?)),
            TransactionResultCode::TxFailed => Ok(TransactionResultResult::TxFailed(UnlimitedVarArray::<OperationResult>::from_xdr_buffered(read_stream)?)),
...
impl XdrCodec for PublicKey {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            PublicKey::PublicKeyTypeEd25519(value) => {PublicKeyType::PublicKeyTypeEd25519.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match PublicKeyType::from_xdr_buffered(read_stream)? {
            PublicKeyType::PublicKeyTypeEd25519 => Ok(PublicKey::PublicKeyTypeEd25519(Uint256::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for SignerKey {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            SignerKey::SignerKeyTypeEd25519(value) => {SignerKeyType::SignerKeyTypeEd25519.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            SignerKey::SignerKeyTypePreAuthTx(value) => {SignerKeyType::SignerKeyTypePreAuthTx.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            SignerKey::SignerKeyTypeHashX(value) => {SignerKeyType::SignerKeyTypeHashX.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
            SignerKey::SignerKeyTypeEd25519SignedPayload(value) => {SignerKeyType::SignerKeyTypeEd25519SignedPayload.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match SignerKeyType::from_xdr_buffered(read_stream)? {
            SignerKeyType::SignerKeyTypeEd25519 => Ok(SignerKey::SignerKeyTypeEd25519(Uint256::from_xdr_buffered(read_stream)?)),
            SignerKeyType::SignerKeyTypePreAuthTx => Ok(SignerKey::SignerKeyTypePreAuthTx(Uint256::from_xdr_buffered(read_stream)?)),
            SignerKeyType::SignerKeyTypeHashX => Ok(SignerKey::SignerKeyTypeHashX(Uint256::from_xdr_buffered(read_stream)?)),
            SignerKeyType::SignerKeyTypeEd25519SignedPayload => Ok(SignerKey::SignerKeyTypeEd25519SignedPayload(SignerKeyEd25519SignedPayload::from_xdr_buffered(read_stream)?)),
        }
    }
}
