...
impl XdrCodec for LedgerKeyExpiration {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(read_stream: &mut ReadStream<T>) -> Result<Self, DecodeError> {
        Ok(LedgerKeyExpiration { key_hash: Hash::from_xdr_buffered(read_stream)? })
    }
}
...
impl XdrCodec for ConfigSettingEntry {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ...
            ConfigSettingEntry::ConfigSettingStateExpiration(value) => {
                ConfigSettingId::ConfigSettingStateExpiration.to_xdr_buffered(write_stream);
                value.to_xdr_buffered(write_stream)
            },
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(read_stream: &mut ReadStream<T>) -> Result<Self, DecodeError> {
        match ConfigSettingId::from_xdr_buffered(read_stream)? {
            ...
            ConfigSettingId::ConfigSettingStateExpiration => Ok(ConfigSettingEntry::ConfigSettingStateExpiration(
                StateExpirationSettings::from_xdr_buffered(read_stream)?,
            )),
    ...
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ...
            ContractExecutable::ContractExecutableToken =>
                ContractExecutableType::ContractExecutableToken.to_xdr_buffered(write_stream),
        }
    }
...
impl XdrCodec for LedgerEntryData {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ...
            LedgerEntryData::Expiration(value) => {
                LedgerEntryType::Expiration.to_xdr_buffered(write_stream);
                value.to_xdr_buffered(write_stream)
            },
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(read_stream: &mut ReadStream<T>) -> Result<Self, DecodeError> {
        match LedgerEntryType::from_xdr_buffered(read_stream)? {
            ...
            LedgerEntryType::Expiration =>
                Ok(LedgerEntryData::Expiration(ExpirationEntry::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for LedgerKey {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(read_stream: &mut ReadStream<T>) -> Result<Self, DecodeError> {
        match LedgerEntryType::from_xdr_buffered(read_stream)? {
            ...
            LedgerEntryType::Expiration =>
                Ok(LedgerKey::Expiration(LedgerKeyExpiration::from_xdr_buffered(read_stream)?)),
        }
    }
}
...
impl XdrCodec for OperationBody {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ...
            OperationBody::BumpFootprintExpiration(value) => {
                OperationType::BumpFootprintExpiration.to_xdr_buffered(write_stream);
                value.to_xdr_buffered(write_stream)
            },
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(read_stream: &mut ReadStream<T>) -> Result<Self, DecodeError> {
        match OperationType::from_xdr_buffered(read_stream)? {
            ...
            OperationType::BumpFootprintExpiration =>
                Ok(OperationBody::BumpFootprintExpiration(BumpFootprintExpirationOp::from_xdr_buffered(read_stream)?)),
...
impl XdrCodec for InvokeHostFunctionResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ...
            InvokeHostFunctionResult::InvokeHostFunctionEntryExpired =>
                InvokeHostFunctionResultCode::InvokeHostFunctionEntryExpired.to_xdr_buffered(write_stream),
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(read_stream: &mut ReadStream<T>) -> Result<Self, DecodeError> {
        match InvokeHostFunctionResultCode::from_xdr_buffered(read_stream)? {
            ...
            InvokeHostFunctionResultCode::InvokeHostFunctionEntryExpired =>
                Ok(InvokeHostFunctionResult::InvokeHostFunctionEntryExpired),
...
impl XdrCodec for BumpFootprintExpirationResult {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            BumpFootprintExpirationResult::BumpFootprintExpirationSuccess =>
                BumpFootprintExpirationResultCode::BumpFootprintExpirationSuccess.to_xdr_buffered(write_stream),
            BumpFootprintExpirationResult::BumpFootprintExpirationMalformed =>
                BumpFootprintExpirationResultCode::BumpFootprintExpirationMalformed.to_xdr_buffered(write_stream),
            BumpFootprintExpirationResult::BumpFootprintExpirationResourceLimitExceeded =>
                BumpFootprintExpirationResultCode::BumpFootprintExpirationResourceLimitExceeded
                    .to_xdr_buffered(write_stream),
            BumpFootprintExpirationResult::BumpFootprintExpirationInsufficientRefundableFee =>
                BumpFootprintExpirationResultCode::BumpFootprintExpirationInsufficientRefundableFee
                    .to_xdr_buffered(write_stream),
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(read_stream: &mut ReadStream<T>) -> Result<Self, DecodeError> {
        match BumpFootprintExpirationResultCode::from_xdr_buffered(read_stream)? {
            BumpFootprintExpirationResultCode::BumpFootprintExpirationSuccess =>
                Ok(BumpFootprintExpirationResult::BumpFootprintExpirationSuccess),
            BumpFootprintExpirationResultCode::BumpFootprintExpirationMalformed =>
                Ok(BumpFootprintExpirationResult::BumpFootprintExpirationMalformed),
            BumpFootprintExpirationResultCode::BumpFootprintExpirationResourceLimitExceeded =>
                Ok(BumpFootprintExpirationResult::BumpFootprintExpirationResourceLimitExceeded),
            BumpFootprintExpirationResultCode::BumpFootprintExpirationInsufficientRefundableFee =>
                Ok(BumpFootprintExpirationResult::BumpFootprintExpirationInsufficientRefundableFee),
        }
    }
}
...
impl XdrCodec for OperationResultTr {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            ...
            OperationResultTr::BumpFootprintExpiration(value) => {
                OperationType::BumpFootprintExpiration.to_xdr_buffered(write_stream);
                value.to_xdr_buffered(write_stream)
            },
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(read_stream: &mut ReadStream<T>) -> Result<Self, DecodeError> {
        match OperationType::from_xdr_buffered(read_stream)? {
            ...
            OperationType::BumpFootprintExpiration => Ok(OperationResultTr::BumpFootprintExpiration(
                BumpFootprintExpirationResult::from_xdr_buffered(read_stream)?,
            )),
            OperationType::RestoreFootprint =>
