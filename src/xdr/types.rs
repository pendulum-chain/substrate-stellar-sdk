...
//!
// This code has been automatically generated on 2021-07-10
...
/// Autogenerated definition for type AccountIdf
#[allow(dead_code)]
...
/// Autogenerated definition for type StellarSdkError
#[allow(dead_code)]
#[cfg(feature = "all-types")]
#[derive(Debug, Clone, Eq, PartialEq)]
pub struct StellarSdkError {
    pub code: ErrorCode,
    pub msg: LimitedString<100>,
}

#[cfg(feature = "all-types")]
impl XdrCodec for StellarSdkError {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
...
impl XdrCodec for StellarMessage {
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match MessageType::from_xdr_buffered(read_stream)? {
            MessageType::ErrorMsg => Ok(StellarMessage::ErrorMsg(
                StellarSdkError::from_xdr_buffered(read_stream)?,
            )),
