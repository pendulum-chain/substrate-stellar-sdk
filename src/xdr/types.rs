...
//!
// This code has been automatically generated on 2022-11-07
...
/// Autogenerated definition for constant AUTH_MSG_FLAG_PULL_MODE_REQUESTED
#[allow(dead_code)]
pub const AUTH_MSG_FLAG_PULL_MODE_REQUESTED: i32 = 100;
...
impl XdrCodec for SurveyResponseBody {
    fn to_xdr_buffered(&self, write_stream: &mut WriteStream) {
        match self {
            SurveyResponseBody::SurveyTopology(value) => {SurveyMessageCommandType::SurveyTopology.to_xdr_buffered(write_stream); value.to_xdr_buffered(write_stream)},
        }
    }
    ...
    fn from_xdr_buffered<T: AsRef<[u8]>>(
        ...
        match SurveyMessageCommandType::from_xdr_buffered(read_stream)? {
            SurveyMessageCommandType::SurveyTopology => Ok(SurveyResponseBody::SurveyTopology(TopologyResponseBody::from_xdr_buffered(read_stream)?)),
        }
    }
}
